...
-- Body
gear.taeon_body_Fastcast = {name="Taeon Tabard", augments={'"Fast Cast"+4',}}
...
-- Pet DT
gear.telchine_head_Pet = { name="Telchine Cap", augments={'Mag. Evasion+17','Pet: "Regen"+3','Pet: Damage taken -3%',}}
...
-- Head occult Leafdim
gear.helios_head_occult = { name="Helios Band", augments={'Pet: Attack+29 Pet: Rng.Atk.+29','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+7',}}
...
--------------------------------------
	...
	gear.gada_enhancing_club = "Gada"
	gear.gada_healing_club = "Gada"
	gear.gada_indi_club = "Gada"
...
-- Head
	...
	gear.chirionic_phalanx_head = { name="Chironic Hat", augments={'AGI+5','Mag. Acc.+19','Phalanx +3','Mag. Acc.+6 "Mag.Atk.Bns."+6',}}
	gear.chironic_refresh_head = "Chironic Hat"
	
-- Body
	gear.chirionic_phalanx_body = { name="Chironic Doublet", augments={'AGI+1','"Conserve MP"+3','Phalanx +3',}}

-- Hands 
	gear.chirionic_phalanx_hands = {}
	gear.chironic_refresh_hands = {name="Chironic Gloves", augments={'Accuracy+4','"Fast Cast"+3','"Refresh"+1','Accuracy+8 Attack+8',}}

-- Legs	
	gear.chirionic_phalanx_legs = { name="Chironic Hose", augments={'Accuracy+30','Phalanx +3','Mag. Acc.+2 "Mag.Atk.Bns."+2',}}
	-- 30+ Macc
	gear.chironic_macc_legs 	= { name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','INT+9','"Refresh"+1',}}
	gear.chironic_refresh_legs	= { name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','INT+9','"Refresh"+1',}}
	
	gear.chironic_cure_legs = "Chironic Hose"
	
-- Feet	
	gear.chirionic_phalanx_feet = {}
	gear.chironic_refresh_feet = {name="Chironic Slippers", augments={'"Blood Pact" ability delay -1','Pet: INT+4','"Refresh"+2','Accuracy+18 Attack+18','Mag. Acc.+7 "Mag.Atk.Bns."+7',}}
...
-- Head 
	...
	gear.merlinic_phalanx_head = {name="Merlinic Hood", augments={'CHR+8','MND+6','Phalanx +2',}}
...
-- Body 
	...
	-- FC
	gear.merlinic_fc_body = {name="Merlinic Jubbah", augments={'Mag. Acc.+6 "Mag.Atk.Bns."+6','AGI+5','"Fast Cast"+7',}}
	-- Drain/Aspir +10
	--gear.merlinic_aspir_body = {}
	-- Occult Acumen +11
	--gear.merlinic_body_occult = {}
