...
function init_gear_sets()
	...
	sets.precast.JA['Chakra'] = {
		...
		--  Hes. Gloves +3
		body="Anch. Cyclas +3", hands="Hesychast's Gloves +1", ring1="Gelatinous Ring +1", ring2="Niqmaddu Ring",
	...
	sets.precast.Step = {ammo="Ginsen", -- Staunch Tathlum +1
		...
		-- Malignance Gloves 
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt
	...
	sets.precast.FC = {ammo="Hasty Pinion +1", -- Sapience Orb
	...
	sets.precast.WS = {ammo="Knobkierrie",
		...
		body=gear.herculean_wsd_body,hands="Anchor. Gloves +3",ring1="Niqmaddu Ring",ring2="Epona's Ring",
	...
	sets.precast.WS["Ascetic's Fury"]  = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		...
		body="Anch. Cyclas +3",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- Moonbow Belt +1 Ken. Hakama +1 Ken. Sune-Ate +1
		back=gear.Chakra_jse_back,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +2"})
	...
	sets.precast.WS['Tornado Kick']    = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		...
		body="Mummu Jacket +2",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- Ken. Hakama +1 
		back=gear.Chakra_jse_back,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet="Anch. Gaiters +3"})
	...
	sets.engaged = {ammo="Ginsen",
		...
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		--  Gere Ring
		body="Ashera Harness",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- waist="Moonlight Belt +1", legs="Hes. Hose +3",
		back=gear.TP_jse_back,waist="Windbuffet Belt",legs="Samnuha Tights",feet="Anch. Gaiters +3"}
	...
	sets.engaged.PDT = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		--  Malignance Gloves 
		body="Malignance Tabard", hands="Mummu Wrists +2",ring1="Defending Ring",ring2="Niqmaddu Ring",
