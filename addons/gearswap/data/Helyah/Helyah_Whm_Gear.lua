...
function init_gear_sets()
    ...
    sets.precast.FC = { ammo="Incantor Stone",
		...
		body="Inyanga Jubbah +2", hands="Aya. Manopolas +2", lring="Prolix Ring", rring="Defending Ring",
	...
	sets.midcast['Enhancing Magic'] = {ammo="Clarus Stone",
		--main="Boonwell Staff", sub="Fulcio Grip", main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",
	...
	sets.midcast.BarElement = {ammo="Clarus Stone",
		--main="Boonwell Staff", sub="Fulcio Grip", main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",		
		--  neck="Incantor's Torque",   
		head=gear.telchine_head_Duration, lear="Andoaa Earring", 
		body=gear.telchine_body_Duration, hands=gear.telchine_hands_Duration, lring="Stikini Ring +1", rring="Stikini Ring +1",
		--  feet="Theophany Duckbills +3"
		back="Mending Cape", waist="Olympus Sash", legs=gear.telchine_legs_Duration, feet=gear.telchine_feet_Duration}
	
	sets.midcast.BarElement['Light Arts'] = {ammo="Clarus Stone",
	...
	sets.midcast.BarStatus = {ammo="Clarus Stone",
		-- main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",
		-- neck="Incantor's Torque",  
		head=gear.telchine_head_Duration, lear="Andoaa Earring", 
	...
	sets.midcast.BarStatus['Light Arts'] = {ammo="Clarus Stone",
		-- main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",
		-- neck="Incantor's Torque",  
		head=gear.telchine_head_Duration, lear="Andoaa Earring", 
	...
	-- 500 Skill
	sets.midcast.BoostStat = {ammo="Clarus Stone",
		-- main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",
		-- neck="Incantor's Torque",  
		head=gear.telchine_head_Duration, lear="Andoaa Earring", 
	...
	sets.midcast.BoostStat['Light Arts'] = {ammo="Clarus Stone",
		-- main=gear.gada_enhancing_club, 
		sub="Ammurapi Shield",
		-- neck="Incantor's Torque",  
		head=gear.telchine_head_Duration, lear="Andoaa Earring", 
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {
		--main="Bolelabunga", 
		main=empty, sub="Ammurapi Shield",
	...
	sets.midcast['Elemental Magic'].Resistant = {-- Grioavolr Pemphredo Tathlum
		...
		-- Chironic Hat, neck="Voltsurge Torque",lear="Regal Earring", rear="Malignance Earring",
		head="Inyanga Tiara +2", rear="Enchntr. Earring +1",
		body="Theo. Briault +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		--  Chironic Hose Theo. Duckbills +3
		back=gear.Macc_jse_back, waist="Acuity Belt +1", legs="Inyanga Shalwar +2", feet="Inyan. Crackows +2"}
	...
	sets.midcast['Divine Magic'] = {-- Grioavolr Pemphredo Tathlum
		main="Maxentius", sub="Ammurapi Shield",
		-- Chironic Hat, neck="Voltsurge Torque",lear="Regal Earring", rear="Malignance Earring",
		head="Inyanga Tiara +2", lear="Beatific Earring", rear="Enchntr. Earring +1",
		body="Theo. Briault +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		--  Chironic Hose Theo. Duckbills +3
		back=gear.Macc_jse_back, waist="Acuity Belt +1", legs="Inyanga Shalwar +2", feet="Inyan. Crackows +2"}
	...
	sets.midcast.Stun.Resistant = {-- Grioavolr Pemphredo Tathlum
		...
		back="Felicitas Cape +1", legs="Inyanga Shalwar +2", feet="Inyan. Crackows +2"}
	...
	sets.resting = {main="Boonwell Staff",
		head="Inyanga Tiara +2", neck="Eidolon Pendant",
		body="Theo. Bliaut",hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.fastcast_jse_back, waist="Austerity Belt",legs="Inyanga Shalwar +2",feet="Volte Gaiters"}

    -- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)
	sets.idle = {main="Mafic Cudgel", sub="Genmei Shield",
		-- ammo="Homillary",
		-- rear="Etiolation Earring",
		head="Befouled Crown", neck="Loricate Torque +1", lear="Ethereal Earring",
		body="Theo. Bliaut +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		-- legs="Assid. Pants +1",
		back=gear.fastcast_jse_back, waist="Austerity Belt", legs="Aya. Cosciales +2", feet="Volte Gaiters"}

	sets.idle.PDT = {main="Mafic Cudgel", sub="Genmei Shield",
		-- ammo="Homillary",
		-- rear="Etiolation Earring",
		head="Aya. Zucchetto +2", neck="Loricate Torque +1", lear="Ethereal Earring",
		-- Shamash Robe 
		body="Theo. Briault +3",  hands="Aya. Manopolas +2", lring="Inyanga Ring", rring="Defending Ring",
		-- legs="Assid. Pants +1",
		back=gear.fastcast_jse_back, waist="Austerity Belt", legs="Aya. Cosciales +2", feet="Aya. Gambieras +2"}
		
	sets.idle.MEVA = {main="Mafic Cudgel", sub="Genmei Shield",
		-- main=gear.grioavolr_fc_staff, sub="Irenic Strap +1",
		-- rear="Etiolation Earring",
		head="Inyanga Tiara +2", neck="Loricate Torque +1", lear="Ethereal Earring", 
	...
	sets.defense.MDT ={main="Mafic Cudgel", sub="Genmei Shield",
		-- main=gear.grioavolr_fc_staff, sub="Irenic Strap +1",
		-- rear="Etiolation Earring",
		head="Inyanga Tiara +2", neck="Loricate Torque +1", lear="Ethereal Earring",
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Inyanga Ring", rring="Defending Ring",
    ...
    sets.defense.MEVA = {main="Mafic Cudgel", sub="Genmei Shield",
		-- main=gear.grioavolr_fc_staff, sub="Irenic Strap +1",
		-- rear="Etiolation Earring",
		head="Inyanga Tiara +2", neck="Loricate Torque +1", lear="Ethereal Earring",
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Inyanga Ring", rring="Defending Ring",
    ...
    sets.engaged = {	
		...
		legs="Aya. Cosciales +2", feet="Aya. Gambieras +2"}
