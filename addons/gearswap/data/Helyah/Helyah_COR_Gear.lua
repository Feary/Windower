...
function init_gear_sets()
	...
	sets.precast.JA['Triple Shot'] = {body="Chasseur's Frac", hands="Lanun Gants +2"}
    ...
    sets.precast.CorsairRoll = {ammo="Compensator",
		--  Earring 
		head="Lanun Tricorne +2", neck="Regal Necklace", lear="Etiolation Earring", rear="Odnowa Earring +1",
		-- Gelatinous Ring +1
    ...
    sets.idle = {ammo=gear.RAbullet,
        head="Meghanada Visor +2", neck="Loricate Torque +1", lear="Eabani Earring", rear="Odnowa Earring +1",
    ...
    sets.idle.Refresh = {ammo=gear.RAbullet,
		-- Rawhide Mask
		head="Meghanada Visor +2", neck="Loricate Torque +1", lear="Eabani Earring", rear="Merman's Earring",
