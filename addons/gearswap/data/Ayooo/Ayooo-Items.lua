...
sets.Capacity =  {back={name="Mecisto. Mantle", augments={'Cap. Point+50%','HP+22','DEF+3',}}}

sets.buff.RolledEleven = {} --ring2="Roller's Ring"
sets.buff.Doom = {waist="Gishdubar Sash"}--ring1="Eshmun's Ring",ring2="Eshmun's Ring"

-- Base TH Gear Caps at 4 - ammo="Per. Lucky Egg" leave out not for RNG COR
sets.TreasureHunter = {head="Volte Cap", hands="Volte Bracers", waist="Chaac Belt"}
...
gear.taeon_head_Phalanx = {name="Taeon Chapeau", augments={'"Fast Cast"+5','Phalanx +3',}}
gear.taeon_head_pettp = { name="Taeon Chapeau", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}

-- Body
gear.taeon_body_Fastcast = {name="Taeon Tabard", augments={'"Fast Cast"+5','Phalanx +3',}}
gear.taeon_body_Phalanx = {name="Taeon Tabard", augments={'"Fast Cast"+5','Phalanx +3',}}
gear.taeon_body_pettp ={ name="Taeon Tabard", augments={'Pet: Attack+25 Pet: Rng.Atk.+25','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}

-- Hands
gear.taeon_hands_Phalanx = {name="Taeon Gloves", augments={'"Fast Cast"+5','Phalanx +3',}}
gear.taeon_hands_pettp ={ name="Taeon Gloves", augments={'Pet: Accuracy+23 Pet: Rng. Acc.+23','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}

-- Legs
gear.taeon_legs_Phalanx = {name="Taeon Tights", augments={'"Fast Cast"+5','Phalanx +3',}}
...
-- Body  Leaforb 
gear.telchine_body_Duration = { name="Telchine Chas.", augments={'Enh. Mag. eff. dur. +9',}}
gear.telchine_body_Siphon = { name="Telchine Chas.", augments={'Enh. Mag. eff. dur. +10',}}
...
gear.telchine_hands_Duration = { name="Telchine Gloves", augments={'Pet: "Regen"+2','Enh. Mag. eff. dur. +10',}}
...
-- Head
--leafdim Snowdon duskdim
gear.helios_head_occult = { name="Helios Band", augments={'Pet: Attack+26 Pet: Rng.Atk.+26','Pet: "Dbl. Atk."+8','Blood Pact Dmg.+6',}}
...
--------------------------------------
	...
	gear.vanya_hood_patha = {}
	gear.vanya_hood_pathb = {name="Vanya Hood", augments={'Healing magic skill +20','"Cure" spellcasting time -7%','Magic dmg. taken -3',}}
	
	gear.vanya_clog_pathb = {name="Vanya Clogs", augments={'Healing magic skill +20','"Cure" spellcasting time -7%','Magic dmg. taken -3',}}
...
--------------------------------------
	...
	gear.gada_enhancing_club = {name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+20','"Mag.Atk.Bns."+15',}}
	gear.gada_refresh_club = {name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+20','"Mag.Atk.Bns."+15',}}
	gear.gada_healing_club = {name="Gada", augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+20','"Mag.Atk.Bns."+15',}}

	gear.gada_indi_club = {}
	
	gear.grioavolr_nuke_staff = {name="Grioavolr", augments={'"Conserve MP"+3','MND+12','Mag. Acc.+21','"Mag.Atk.Bns."+29','Magic Damage +9',}}
	gear.grioavolr_macc_staff = {name="Grioavolr", augments={'Enfb.mag. skill +15','VIT+14','Mag. Acc.+24','"Mag.Atk.Bns."+4','Magic Damage +8',}}
	--gear.grioavolr_refresh_staff = {name="Grioavolr", augments={'Mag. Acc.+5','MND+10','"Refresh"+1',}}
	--{name="Grioavolr",augments={'"Fast Cast"+7','MP+20','Mag. Acc.+17','"Mag.Atk.Bns."+10','Magic Damage +5',}}
	gear.grioavolr_fc_staff = {name="Grioavolr", augments={'"Fast Cast"+6','Mag. Acc.+7','Magic Damage +2',}}
...
-- Head
	...
	gear.chironic_aspir_head = {name="Chironic Hat", augments={'AGI+2','"Drain" and "Aspir" potency +8','Quadruple Attack +3','Accuracy+6 Attack+6','Mag. Acc.+4 "Mag.Atk.Bns."+4',}}
...
-- Legs
	-- +30
	gear.chironic_macc_legs = {name="Chironic Hose", augments={'Phys. dmg. taken -2%','Enmity-6','"Fast Cast"+8','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}
	--gear.chironic_cure_legs = {name="Chironic Hose", augments={'Mag. Acc.+24','"Cure" potency +11%','"Mag.Atk.Bns."+4',}}
	gear.chironic_refresh_legs = {name="Chironic Hose", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','"Drain" and "Aspir" potency +9','INT+8','Mag. Acc.+15','"Mag.Atk.Bns."+3',}}
	gear.chironic_fastcast_legs = {name="Chironic Hose", augments={'Phys. dmg. taken -2%','Enmity-6','"Fast Cast"+8','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}

-- Feet	
	--gear.chironic_refresh_legs = {name="Chironic Slippers",augments={'Pet: Mag. Acc.+18 Pet: "Mag.Atk.Bns."+18','Pet: Mag. Acc.+3','"Refresh"+1','Accuracy+13 Attack+13','Mag. Acc.+8 "Mag.Atk.Bns."+8',}}
...
-- Body
	gear.herculean_phalanx_body = { name="Herculean Vest", augments={'Attack+15','"Cure" spellcasting time -6%','Phalanx +4',}}
...
-- Head 
	gear.merlinic_refresh_head = {name="Merlinic Hood", augments={'Attack+18','STR+7','"Refresh"+2',}}
	-- Summoner?
	-- FC +4 or more
	gear.merlinic_fc_head =  {name="Merlinic Hood", augments={'Mag. Acc.+23','"Fast Cast"+6',}}
	-- Drain/Aspir +10
	gear.merlinic_aspir_head = {name="Merlinic Hood", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','"Drain" and "Aspir" potency +10','AGI+10','Mag. Acc.+3',}}
	-- to be replaced Nyame/agwu
	gear.merlinic_nuke_head = {name="Merlinic Hood", augments={'"Mag.Atk.Bns."+27','Mag. Acc.+21','Magic burst dmg.+2%','Accuracy+4 Attack+4',}}
	gear.merlinic_phalanx_head =  {name="Merlinic Hood", augments={'Accuracy+4','Pet: "Dbl. Atk."+1','Phalanx +2','Accuracy+20 Attack+20',}}
	
-- Body 
	gear.merlinic_phalanx_body = { name="Merlinic Jubbah", augments={'Pet: CHR+2','Mag. Acc.+20 "Mag.Atk.Bns."+20','Phalanx +3',}}
	-- Drain/Aspir +10
	gear.merlinic_aspir_body = "Merlinic Jubbah"
	gear.merlinic_occult_body = "Merlinic Jubbah"

-- Hands
	gear.merlinic_magpact_hands = {name="Merlinic Dastanas",  augments={'Pet: "Mag.Atk.Bns."+25','Blood Pact Dmg.+8','Pet: INT+15',}}
	gear.merlinic_maccpact_hands = {name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+21','Blood Pact Dmg.+10','Pet: "Mag.Atk.Bns."+6',}}
	gear.merlinic_physpact_hands = {name="Merlinic Dastanas", augments={'Pet: Attack+20 Pet: Rng.Atk.+20','Blood Pact Dmg.+9','Pet: Mag. Acc.+11','Pet: "Mag.Atk.Bns."+11',}}
	gear.merlinic_accpact_hands = {name="Merlinic Dastanas",  augments={'Pet: Accuracy+17 Pet: Rng. Acc.+17','Blood Pact Dmg.+10','Pet: DEX+9','Pet: "Mag.Atk.Bns."+6',}}
	...
	-- Drain/Aspir +10
	gear.merlinic_aspir_hands = {name="Merlinic Dastanas", augments={'"Mag.Atk.Bns."+9','"Drain" and "Aspir" potency +11','INT+6',}}
	-- OA +11
	gear.merlinic_occult_hands = "Merlinic Dastanas"
	
-- Legs 
	-- Refresh +2
	gear.merlinic_refresh_legs = {name="Merlinic Shalwar", augments={'MND+1','"Resist Silence"+5','"Refresh"+2','Mag. Acc.+7 "Mag.Atk.Bns."+7',}}
	
	--extra 
	gear.merlinic_aspir_legs = {name="Merlinic Shalwar", augments={'Mag. Acc.+18','"Drain" and "Aspir" potency +11',}}

-- Feet 
	-- Drain/Aspir +10
	gear.merlinic_aspir_feet = { name="Merlinic Crackows", augments={'Attack+10','"Drain" and "Aspir" potency +10','MND+3','Mag. Acc.+11',}}
	-- FC +7
	gear.merlinic_fc_feet = {name="Merlinic Crackows", augments={'"Fast Cast"+6','CHR+6','"Mag.Atk.Bns."+13',}}
