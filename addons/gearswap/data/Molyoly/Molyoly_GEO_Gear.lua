...
function init_gear_sets()
    ...
    sets.midcast.FastRecast = set_combine(sets.precast.FC,{main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1",
		...
		head="Amalric Coif +1", neck="Voltsurge Torque", ear1="Enchntr. Earring +1", ear2="Malignance Earring",
		body="Zendik Robe", hands=gear.helios_hands_FC, ring1="Kishar Ring", ring2="Prolix Ring", 
		back=gear.FC_jse_back, waist="Witful Belt", legs="Geomancy Pants +3", feet="Amalric Nails +1"})

	sets.midcast.Geomancy = {main="Idris", sub="Ammurapi Shield", range="Dunna",
		-- neck="Incantor's Torque", 
		head="Azimuth Hood +1", neck="Melic Torque", lear="Ethereal Earring", rear="Calamitous Earring",
		body="Bagua Tunic +3", hands="Geo. Mitaines +3", lring="Mephitas Ring +1", rring="Stikini Ring +1",
