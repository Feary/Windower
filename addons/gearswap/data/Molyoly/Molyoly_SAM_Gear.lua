...
function init_gear_sets()
    ...
    sets.precast.Waltz = {
        ...
        waist="Chaac Belt",legs="Wakido Haidate +3",feet="Sak. Sune-Ate +3"}
    ...
    sets.resting = {ammo="Staunch Tathlum +1",
        ...
        body="Hiza. Haramaki +2",hands="Sakonji Kote +3",ring1="Defending Ring",ring2="Dark Ring",
    ...
    sets.idle.Weak = {ammo="Staunch Tathlum +1",
        ...
        body="Crepuscular Mail",hands="Sakonji Kote +3",ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Flume Belt",legs="Flamma Dirs +2",feet="Danzo Sune-ate"}
