function user_job_setup()
	...
	state.Weapons:options('None','NukeWeapons', 'MeleeClub','DualClubs','Malevolence') --'Khatvanga'
...
function init_gear_sets()
	...
	sets.weapons.MeleeStaff = {main="Khatvanga",sub="Bloodrain Strap"}
	sets.weapons.MeleeClub =  {main="Maxentius",sub="Ammurapi Shield"}
	sets.weapons.DualClubs =  {main="Maxentius",sub="Ammurapi Shield"}
    ...
    sets.precast.FC = {main="Oranyan", sub="Clerisy Strap +1", ammo="Sapience Orb",
		...
		back=gear.FC_jse_back,waist="Shinjutsu-no-Obi +1",legs="Volte Brais",feet=gear.merlinic_fc_feet}
	...
	sets.precast.FC.Cure = set_combine(sets.precast.FC, {sub="Clerisy Strap +1", body="Annoint. Kalasiris"}) --main="Serenity",
	...
	sets.precast.FC.Death = {main=gear.grioavolr_Death_staff, sub="Niobid Strap",
		...
		head="Amalric Coif +1", neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		-- rring2="Rahab Ring",
		body="Zendik Robe", hands="Volte Gloves", ring1="Mephitas's Ring +1",ring2="Mephitas's Ring +1",
    ...
    ---- Midcast Sets ----
    sets.midcast.FastRecast = {main="Oranyan", sub="Clerisy Strap +1", ammo="Sapience Orb",
		head="Amalric Coif +1",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
		body="Zendik Robe", hands="Volte Gloves", ring1="Kishar Ring", ring2="Prolix Ring",
    ...
    sets.midcast.LightWeatherCure = {main=gear.gada_healing_club, sub="Sors Shield", ammo="Pemphredo Tathlum",
        head="Vanya Hood", neck="Incanter's Torque", ear1="Mendi. Earring",ear2="Roundel Earring",
        --body="Vanya Robe",
		body="Annoint. Kalasiris", hands=gear.telchine_hands_Cure,ring1="Sirona's Ring",ring2="Mephitas's Ring +1",
        back=gear.FC_jse_back,waist="Shinjutsu-no-Obi +1",legs="Vanya Slops",feet="Vanya Clogs"}
    ...
    sets.midcast.LightDayCure = {main=gear.gada_healing_club, sub="Sors Shield", ammo="Sapience Orb",
        head="Vanya Hood", neck="Incanter's Torque", ear1="Mendi. Earring",ear2="Roundel Earring",
        --body="Vanya Robe",
	...
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club, sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
    ...
    sets.midcast['Enfeebling Magic'] = {main="Contemplator +1",sub="Khonsu", ammo="Pemphredo Tathlum",
		...
		body="Cohort Cloak +1", hands="Regal Cuffs", ring1="Metamor. Ring +1",ring2="Kishar Ring",
    ...
    sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Enfeebling Magic'], {
        ...
        -- Src. Stole +2
		head=empty,neck="Incanter's Torque",ear1="Regal Earring",ear2="Malignance Earring",
		body="Cohort Cloak +1", hands="Spae. Gloves +3", ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
    ...
    sets.midcast['Dark Magic'] = {main="Rubicundity", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
        ...
        --  Agwu's Pigaches
		back="Aurist's Cape +1",waist="Acuity Belt +1",legs="Spae. Tonban +3", feet="Jhakri Pigaches +2"}
    ...
    sets.midcast.Drain = {main="Rubicundity", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
        ...
        -- Agwu's Pigaches
	    back="Aurist's Cape +1",waist="Fucho-no-obi",legs="Spae. Tonban +3", feet=gear.merlinic_aspir_feet}
	...
	-- Death
	sets.midcast.Death = {main="Lathi", sub="Niobid Strap", ammo="Ghastly Tahtlum +1",
		-- Mpaca's Staff 
    ...
    sets.midcast.Stun = {main="Maxentius", sub="Ammurapi Shield", ammo="Sapience Orb",
		head="Spae. Petasos +3",neck="Erra Pendant",ear1="Enchntr. Earring +1", ear2="Malignance Earring",
    ...
    sets.midcast.Stun.Resistant = {main="Maxentius", sub="Ammurapi Shield", ammo="Sapience Orb",
		head="Spae. Petasos +3", neck="Erra Pendant", ear1="Enchntr. Earring +1", ear2="Malignance Earring",
		body="Spaekona's Coat +3", hands="Spae. Gloves +3", ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back=gear.nuke_jse_back,waist="Acuity Belt +1", legs="Spae. Tonban +3", feet="Spae. Sabots +3"}
		
    sets.midcast.BardSong = sets.midcast['Enfeebling Magic'].Resistant
	...
	-- Low Tier
    sets.midcast['Elemental Magic'] = {main="Lathi",sub="Niobid Strap",ammo="Ghastly Tahtlum +1",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Lathi",sub="Niobid Strap",ammo="Ghastly Tahtlum +1",
        head="Arch. Petasos +3",neck="Saevus Pendant +1",ear1="Barkaro. Earring",ear2="Malignance Earring",
		-- Freke Ring
		body="Arch. Coat +3",hands="Arch. Gloves +3",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
        back=gear.nuke_jse_back,waist="Acuity Belt +1",legs="Arch. Tonban +3",feet="Arch. Sabots +3"}
		
    sets.midcast['Elemental Magic'].Fodder = {main="Lathi",sub="Niobid Strap",ammo="Ghastly Tahtlum +1",
        head="Arch. Petasos +3",neck="Saevus Pendant +1",ear1="Barkaro. Earring",ear2="Malignance Earring",
		-- Freke Ring
		body="Arch. Coat +3",hands="Arch. Gloves +3",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
        back=gear.nuke_jse_back,waist="Acuity Belt +1",legs="Arch. Tonban +3",feet="Arch. Sabots +3"}
	...
	sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {
		main="Lathi",sub="Niobid Strap",ammo="Ghastly Tahtlum +1",
        head="Arch. Petasos +3",neck="Saevus Pendant +1",ear1="Barkaro. Earring",ear2="Malignance Earring",
		-- Freke Ring 
		body="Arch. Coat +3",hands="Arch. Gloves +3",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
        back=gear.nuke_jse_back,waist="Acuity Belt +1",legs="Arch. Tonban +3",feet="Arch. Sabots +3"})
    ...
    sets.midcast['Elemental Magic'].Proc = {main=empty,sub=empty,ammo="Impatiens",
		...
		body="Spaekona's Coat +3", hands=gear.helios_hands_FC, ring1="Kishar Ring",ring2="Prolix Ring",
    ...
    sets.idle = {main="Contemplator +1", sub="Khonsu", ammo="Staunch Tathlum +1",
		head="Volte Beret",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
		-- hands=gear.merlinic_refresh_hands,
		body="Shamash Robe", hands="Volte Gloves", ring1="Gelatinous Ring +1",ring2="Defending Ring",
    ...
    sets.idle.Weak = {main="Malignance Pole",sub="Khonsu",ammo="Staunch Tathlum +1",
		...
		-- hands=gear.merlinic_refresh_hands,
		body="Shamash Robe", hands="Amalric Gages +1", ring1="Gelatinous Ring +1",ring2="Defending Ring",
    ...
    sets.defense.MEVA = {main="Malignance Pole", sub="Irenic Strap +1", ammo="Staunch Tathlum +1",
		head="Befouled Crown",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
		-- hands=gear.merlinic_refresh_hands,
		body="Shamash Robe", hands="Volte Bracers", ring1="Gelatinous Ring +1",ring2="Defending Ring",
		-- waist="Flax Sash", feet=gear.merlinic_refresh_feet
		back=gear.FC_jse_back, waist="Fucho-no-obi", legs="Assid. Pants +1",feet="Mallquis Clogs +2"}
	...
	sets.HPDown = {
		head=empty, neck="", ear1="Genmei Earring",ear2="Evans Earring",
		body=empty,hands=empty,ring1="Mephitas's Ring +1",ring2="Mephitas's Ring",
		back=empty,legs=empty,feet=empty}
	sets.HPCure = {}
		--main=gear.gada_healing_club,sub="Sors Shield",ammo="Sapience Orb",
	...
	sets.RecoverBurst = {neck="Mizu. Kubikazari",body="Spaekona's Coat +3",hands="Amalric Gages +1",ring1="Mujin Band",feet="Jhakri Pigaches +2"} --head="Ea Hat", legs="Ea Slops", 
	sets.ResistantRecoverBurst = {neck="Mizu. Kubikazari",hands="Amalric Gages +1",body="Spaekona's Coat +3",ring1="Mujin Band",feet="Jhakri Pigaches +2"} -- head="Ea Hat",legs="Ea Slops",
    ...
    -- Normal melee group
    sets.engaged = {ammo="Lathi", sub="Khonsu", ammo="Sapience Orb",
		-- Amar Cluster
...
autows_list = {
		['Default']='Myrkr',
		['NukeWeapons']='Myrkr',
		['MeleeStaff']='Leaden Salute',
		['MeleeClub']='Last Stand',
		['DualClubs']='Savage Blade',
		}