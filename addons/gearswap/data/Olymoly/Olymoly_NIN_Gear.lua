...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Paeapua",
        head="Dampening Tam",neck="Moonlight Necklace",ear1="Friomisi Earring",ear2="Cryptic Earring",
    ...
    sets.precast.FC = {ammo="Sapience Orb",
		...
		back=gear.fc_jse_back, legs="Gyve Trousers", feet="Mochi. Kyahan +3"}
    ...
    sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS, {ammo="Yetshila +1",
		-- neck="Ninja Nodowa +2",
		head="Adhemar Bonnet +1", neck="Caro Necklace",  ear1="Lugra Earring +1", ear2="Odr Earring",
		...
		back=gear.wsd_jse_back, waist="Salifi Belt +1 ", legs="Mochi. Hakama +3",  feet="Mummu Gamash. +2"})
    ...
    sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {ammo="Seeth. Bomblet +1",
		-- neck="Ninja Nodowa +2",
		head="Hachi. Hatsu. +3", neck="Caro Necklace", ear1="Moonshade Earring",ear2="Lugra Earring +1",
		-- Nyame Mail lring="Gere Ring"
		body=gear.herculean_wsd_body, hands="Mochizuki Tekko +3", lring="Epaminondas's Ring", rring="Regal Ring",
		back=gear.wsd_jse_back, waist="Salifi Belt +1", legs="Mochi. Hakama +3", feet="Mochi. Kyahan +3"})
	...
	sets.precast.WS['Blade: Teki'] = {ammo="Seeth. Bomblet +1",
		-- Nyame Helm neck="Ninja Nodowa +2", 
		head="Mochi. Hatsuburi +3", neck="Sanctity Necklace", lear="Lugra Earring +1", rear="Moonshade Earring",
	...
	sets.precast.WS['Blade: Ku'] = {ammo="Seething Bomblet +1",
		-- neck="Ninja Nodowa +2", 
		head="Adhemar Bonnet +1", neck="Fotia Gorget", lear="Lugra Earring +1", rear="Mache Earring +1",
		-- Agony Jerkin +1  lring="Gere Ring",
		body="Adhemar Jacket +1", hands="Mochizuki Tekko +3", lring="Ilabrat Ring", rring="Regal Ring",
	...
	sets.precast.WS['Blade: Kamu'] = {ammo="Seething Bomblet +1",
		-- neck="Ninja Nodowa +2", rear="Balder Earring +1"
		head="Hachi. Hatsu. +3", neck="Sanctity Necklace", lear="Lugra Earring +1", rear="Cessance Earring",
		-- lring="Gere Ring",
		body="Tatena. Haramaki +1", hands="Tatena. Gote +1", lring="Epaminondas's Ring", rring="Epona's Ring",
		back=gear.wsd_jse_back, waist=" Salifi Belt +1", legs="Tatena. Haidate +1", feet="Tatena. Sune. +1"}
	
	-- Sword
	sets.precast.WS['Savage Blade'] = {ammo="Seething Bomblet +1",
        -- neck="Rep. Plat. Medal" neck="Baetyl Pendant"
		head="Hachi. Hatsu. +3",neck="Caro Necklace",ear1="Lugra Earring",ear2="Moonshade Earring",
		...
		back=gear.wsd_jse_back, waist="Salifi Belt +1", legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.precast.WS['Evisceration'] = {ammo="Yetshila +1",
        ...
        -- Ken. Samue +1 body="Mpaca's Doublet",  ring2="Gere Ring"
		body="Abnoba Kaftan", hands="Ryuo Tekko +1", ring1="Regal Ring",ring2="Ilabrat Ring",
    ...
    sets.midcast.FastRecast = {}
	 ...
	 sets.midcast.NinjutsuDebuff = {ammo="Yamarang",
		-- lear="Hnoss Earring"
        head="Hachi. Hatsu. +3",neck="Sanctity Necklace",ear1="Enchntr. Earring +1",ear2="Digni. Earring",
        body="Malignance Tabard",hands="Malignance Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
        back=gear.Nuke_jse_back,waist="Eschan Stone",legs="Malignance Tights",feet="Mochi. Kyahan +3"}

    sets.midcast.ElementalNinjutsu = {ammo="Ghastly Tathlum +1",
		-- neck="Baetyl Pendant", neck="Sybil Scarf",
        head="Mochi. Hatsuburi +3", neck="Sanctity Necklace", ear1="Crematio Earring",ear2="Friomisi Earring",
        ...
        back=gear.Nuke_jse_back,waist="Orpheus's Sash",legs="Gyve Trousers",feet="Mochi. Kyahan +3"}
		
	sets.MagicBurst = {ammo="Ghastly Tathlum +1",
        head="Mochi. Hatsuburi +3", neck="Warden's Charm +1", ear1="Crematio Earring",ear2="Friomisi Earring",
        -- body="Nyame Mail", hands="Nyame Gauntlets"
	...
	sets.DuskIdle = {feet="Hachiya Kyahan +3"}
	sets.DayIdle = {}
	sets.NightIdle = {}
    ...
    sets.engaged = {ammo="Yamarang",
        ...
        body="Mochi. Chainmail +3",hands="Adhemar Wrist. +1",ring1="Rajas Ring",ring2="Epona's Ring",
	...
	sets.weapons.Kikoku = {main="Kikoku", sub="Ternion Dagger +1"}  
	sets.weapons.Gokotai = {main="Gotokai", sub="Ternion Dagger +1"}
	sets.weapons.Sword = {main="Naegling",sub="Ternion Dagger +1"} 
