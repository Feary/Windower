...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Ginsen", -- Aurgelmir Orb +1
		--  Dls. Torque +2
		head="Viti. Chapeau +3", neck="Dls. Torque +1", lear="Regal Earring", rear="Moonshade Earring",
		body="Viti. Tabard +3", hands="Atrophy Gloves +3", lring="Epaminondas's Ring", rring="Metamor. Ring +1",
		back=gear.ws_jse_back, waist="Salifi Belt +1", legs="Jhakri Slops +2", feet="Carmine Greaves +1"}
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ammo="Regal Gem",
		head="Viti. Chapeau +3", neck="Fotia Gorget", lear="Moonshade Earring", rear="Regal Earring",
		body="Viti. Tabard +3", hands="Atrophy Gloves +3", lring="Metamor. Ring +1", rring="Rufescent Ring",
		back=gear.ws_jse_back, waist="Fotia Belt", legs="Viti. Tights +3", feet="Jhakri Pigaches +2"})
	
	sets.precast.WS['Chant Du Cygne'] = set_combine(sets.precast.WS, {ammo="Yetshila",
		head="Blistering Sallet +1", neck="Fotia Gorget", lear="Mache Earring +1", rear="Sherida Earring", 
	...
	sets.precast.WS['Savage Blade'] = {ammo="Ginsen", -- Aurgelmir Orb +1
		-- Dls. Torque +2
		head="Viti. Chapeau +3", neck="Caro Necklace", lear="Regal Earring", rear="Moonshade Earring",
		-- Atrophy Gloves +3 
		body="Viti. Tabard +3", hands="Jhakri Cuffs +2", lring="Epaminondas's Ring", rring="Metamor. Ring +1",
		back=gear.ws_jse_back, waist="Salifi Belt +1", legs="Jhakri Slops +2", feet="Carmine Greaves +1"}
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",
		--  neck="Baetyl Pendant",
		head="C. Palug Crown", neck="Fotia Gorget", ear1="Regal Earring", rear="Malignance Earring",
	...
	sets.precast.WS['Seraph Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		-- neck="Baetyl Pendant", 
		head="C. Palug Crown",neck="Sanctity Necklace",ear1="Moonshade Earring", ear2="Regal Earring",
		-- rring="Freke Ring",
		body="Amalric Doublet +1",hands="Atrophy Gloves +3",lring="Epaminondas's Ring",ring2="Shiva Ring +1",
	...
	sets.precast.WS['Death Blossom'] = {aammo="Ginsen", -- Aurgelmir Orb +1
		--  Dls. Torque +2
		head="Viti. Chapeau +3", neck="Caro Necklace", lear="Regal Earring", rear="Moonshade Earring",
		body="Viti. Tabard +3", hands="Atrophy Gloves +3", rring="Metamor. Ring +1", rring="Rufescent Ring",
		back=gear.ws_jse_back, waist="Salifi Belt +1", legs="Jhakri Slops +2", feet="Carmine Greaves +1"}
	...
	sets.precast.WS['Aeolian Edge'] = {range=empty,ammo="Pemphredo Tathlum",
		-- neck="Baetyl Pendant",
		head="C. Palug Crown",neck="Sanctity Necklace", ear1="Regal Earring", ear2="Malignance Earring",
		-- Freke Ring
	...
	sets.midcast['Enhancing Magic'] = {main="Maxentius", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		...
		body=gear.telchine_body_Duration, hands="Atrophy Gloves +3", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
	...
	sets.midcast['Enfeebling Magic'] = {main="Maxentius",sub="Ammurapi Shield", range=empty, ammo="Regal Gem",
			-- Dls. Torque +2
			head="Viti. Chapeau +3", neck="Dls. Torque +1", lear="Digni. Earring", rear="Regal Earring",
			body="Atrophy Tabard +3", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
			back=gear.Macc_jse_back, waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Vitiation Boots +3"}
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield", range="Ullr", ammo=empty, 
			--  Dls. Torque +2
			head="Atro. Chapeau +3", neck="Dls. Torque +1", lear="Digni. Earring", rear="Regal Earring",
			body="Atrophy Tabard +3", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
			back=gear.Macc_jse_back, waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Vitiation Boots +3"}
	...
	sets.midcast.Impact = {main="Maxentius", sub="Ammurapi Shield", ammo="Regal Gem",
		...
		body="Crepuscular Cloak", hands="Regal Cuffs", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.Macc_jse_back, waist="Eschan Stone", legs="Psycloth Lappas", feet="Vitiation Boots +3"}
	...
	sets.resting = {main="Daybreak",sub="Genmei Shield",ammo="Homiliary",
		head="Viti. Chapeau +3",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
	...
	sets.idle.PDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Homiliary",
		...
		body="Shamash Robe",hands="Malignance Gloves",ring1="Dark Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
		
	sets.idle.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		-- Sanare Earring
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
		body="Shamash Robe",hands="Malignance Gloves",ring1="Shadow Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
		
	sets.idle.Weak = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
		body="Shamash Robe",hands="Malignance Gloves",ring1="Dark Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Sanare Earring",ear2="Eabani Earring",
		body="Shamash Robe",hands="Malignance Gloves",ring1="Shadow Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.engaged.EnspellOnly = {ammo="Ginsen", --ammo="Aurgelmir Orb +1",
		...
		body="Malignance Tabard",hands="Aya. Manopolas +2",ring1="Metamor. Ring +1",ring2="Ramuh Ring +1",
