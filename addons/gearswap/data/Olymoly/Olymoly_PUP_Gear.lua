...
function user_job_setup()
	...
	sets.weapons.GodhandsII = {main="Godhands",range="Animator P II +1"}
...
function init_gear_sets()
    ...
    sets.precast.FC = {
		...
		back=gear.FC_jse_back ,waist="Goading Belt",legs="Pitre Churidars +3",feet="Regal Pumps +1"}
	...
	sets.precast.JA['Role Reversal'] = {feet="Pitre Babouches +3"}
    ...
    sets.precast.JA.Maneuver = {main="Midnights",--ammo="Animator P +1",
		neck="Bfn. Collar +1",
    ...
    sets.precast.WS = {
        ...
        body="Foire Tobe +3",hands="Pitre Dastanas +3",ring1="Niqmaddu Ring",ring2="Regal Ring",
    ...
    sets.precast.WS['Shijin Spiral'] = set_combine(sets.precast.WS, {
		...
		-- Gere Ring
        body="Tali'ah Manteel +2",hands="Malignance Gloves",ring1="Niqmaddu Ring",ring2="Regal Ring",
        -- Moonbow Belt +1
	...
	sets.midcast.Pet['Enfeebling Magic'] = {
		...
		waist="Incarnation Sash",legs="Tali'ah Sera. +2", legs="Pitre Churidars +3", feet="Pitre Babouches +3"}
    sets.midcast.Pet['Elemental Magic'] = {
		neck="Adad Amulet",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Udug Jacket", hands="Tali'ah Gages +2", ring1="Varar Ring +1",ring2="Varar Ring +1", 
		waist="Incarnation Sash",legs="Tali'ah Sera. +2",feet="Pitre Babouches +3"}
    ...
    sets.idle = {main="Ohtas", range="Animator P +1",
        ...
        body="Hiza. Haramaki +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Gelatinous Ring +1",
    ...
    sets.idle.Pet = {
        head="Pitre Taj +3",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
        body="Hiza. Haramaki +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Gelatinous Ring +1",
    ...
    sets.idle.Pet.Engaged = {
		...
		body="Pitre Tobe +3",hands="Tali'ah Gages +2",ring1="Varar Ring +1",ring2="Varar Ring +1",
    ...
    sets.defense.PDT = {
		...
		body="Udug Jacket",hands="Malignance Gloves",ring1="Defending Ring",ring2="Gelatinous Ring +1", 
    ...
    sets.engaged.Pet = {
		head="Tali'ah Turban +2",neck="Shulmanu Collar",ear1="Cessance Earring",ear2="Telos Earring",
		-- He. Mittens +1
        body="Pitre Tobe +3",hands="Tali'ah Gages +2",ring1="Niqmaddu Ring",ring2="Varar Ring +1",
