function user_job_setup()
    ...
    state.ExtraDefenseMode = M{['description']='Extra Defense Mode', 'None', 'MP', 'Crepuscular'}
...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Sapience Orb",
		...
		body="Souv. Cuirass +1", hands="Souv. Handsch. +1", lring="Vexer Ring +1", rring="Apeile Ring +1",
	...
	sets.Enmity.SIRD = {ammo="Staunch Tathlum +1", -- Impatiens
		...
		body="Souv. Cuirass +1",hands="Regal Gauntlets",ring1="Defending Ring",ring2="Moonlight Ring",
	...
	sets.Enmity.DT = {ammo="Sapience Orb",
		-- lear="Trux Earring", 
		head="Loess Barbuta +1", neck="Moonlight Necklace", lear="Odnowa Earring +1", rear="Cryptic Earring",
		body="Souv. Cuirass +1", hands="Souv. Handsch. +1", lring="Defending Ring", rring="Apeile Ring +1",
    ...
    sets.precast.JA['Chivalry'] = {ammo="Sapience Orb",
		-- Trux Earring 
		head="Loess Barbuta +1", neck="Moonlight Necklace", lear="Odnowa Earring +1", rear="Cryptic Earring",
		body="Souv. Cuirass +1", hands="Cab. Gauntlets +3", lring="Vexer Ring +1", rring="Apeile Ring +1",
    ...
    sets.precast.FC = {ammo="Sapience Orb",
		...
		body="Rev. Surcoat +3", hands="Souv. Handsch. +1", lring="Moonlight Ring", rring="Moonlight Ring",
		back=gear.fastcast_jse_back, waist="Rumination Sash", legs="Souv. Diechlings +1", feet="Carmine Greaves +1"}
    ...
    sets.precast.WS['Atonement'] = {ammo="Sapience Orb",
		...
		body="Souv. Cuirass +1", hands="Souv. Handsch. +1", lring="Vexer Ring +1", rring="Eiwaz Ring",
		-- Eschite Greaves 
		back=gear.enmity_jse_back, waist="Fotia Belt", legs="Souv. Diechlings +1", feet="Souveran Schuhs +1"}
    ...
    sets.midcast.Cure = {ammo="Egoist's Tathlum",
		...
		body="Souv. Cuirass +1", hands="Macabre Gaunt. +1", lring="Vexer Ring +1", rring="Eiwaz Ring",
		-- feet="Chev. Sabatons +3",
		back=gear.fastcast_jse_back, waist="Creed Baudrier", legs="Souv. Diechlings +1", feet=gear.odyssean_cure_feet}
	...
	sets.midcast.Cure.SIRD = {ammo="Staunch Tathlum +1",
		...
		body="Souv. Cuirass +1", hands="Macabre Gaunt. +1", lring="Gelatinous Ring +1", rring="Eiwaz Ring",
		-- waist="Audumbla Sash" 
	...
	sets.midcast.Reprisal = set_combine(sets.midcast['Enhancing Magic'], {ammo="Sapience Orb",
		...
		body="Souv. Cuirass +1", hands="Souv. Handsch. +1", lring="Vexer Ring +1", rring="Eiwaz Ring",
		-- Chev. Sabatons +3
		back=gear.fastcast_jse_back, waist="Creed Baudrier", legs="Souv. Diechlings +1", feet=gear.odyssean_fc_feet})
	...
	sets.midcast.Flash = set_combine(sets.Enmity, {ammo="Sapience Orb",
		-- lear="Trux Earring", 
		head="Loess Barbuta +1", neck="Moonlight Necklace", lear="Odnowa Earring +1", rear="Cryptic Earring",
		body="Rev. Surcoat +3", hands="Souv. Handsch. +1", lring="Vexer Ring +1", rring="Eiwaz Ring",
		-- Chev. Sabatons +3
		back=gear.fastcast_jse_back, waist="Creed Baudrier", legs="Souv. Diechlings +1", feet=gear.odyssean_fc_feet})
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
		...
		-- Sakpata's Plate Sakpata's Gauntlets 
		body="Cab. Surcoat +3", hands="Souv. Handsch. +1", ring1="Moonlight Ring", ring2="Moonlight Ring",
		-- Chev. Cuisses +3 Sakpata's Leggings
		back=gear.Enmity_jse_back, waist="Sailfi Belt +1", legs="Souv. Diechlings +1", feet="Souveran Schuhs +1"}
    ...
    sets.idle.PDT = {ammo="Staunch Tathlum +1",
		...
		body="Souv. Cuirass +1", hands="Chev. Gauntlets +1", lring="Shadow Ring", rring="Defending Ring",
		-- Asklepian Belt Chev. Cuisses +3
		back="Shadow Mantle", waist="Carrier's Sash", legs="Souv. Diechlings +1", feet="Souveran Schuhs +1"}
	...
	sets.idle.Refresh = {ammo="Homiliary",
		...
		body="Jumalik Mail",hands="Souv. Handsch. +1",ring1="Moonlight Ring",ring2="Defending Ring",
	...
	sets.idle.KiteTank = {ammo="Staunch Tathlum +1",
		...
		body="Cab. Surcoat +3",hands="Souv. Handsch. +1",ring1="Shadow Ring",ring2="Defending Ring",
		back="Shadow Mantle",waist="Flume Belt",legs="Souv. Diechlings +1", feet="Hippo. Socks +1"}
    ...
    sets.idle.Reraise = {ammo="Staunch Tathlum +1",
		...
		body="Crepuscular Mail",hands="Souv. Handsch. +1",ring1="Moonlight Ring",ring2="Defending Ring",
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum +1",
		...
		body="Tartarus Platemail",hands="Souv. Handsch. +1",ring1="Moonlight Ring",ring2="Defending Ring",
    ...
    sets.defense.PDT_Reraise = {ammo="Staunch Tathlum +1",
        ...
        body="Crepuscular Mail",hands="Macabre Gaunt. +1", ring1="Moonlight Ring", ring2="Defending Ring",
		-- legs="Arke Cosciales",
		back="Moonbeam Cape",waist="Flume Belt",legs="Souv. Diechlings +1",feet="Souveran Schuhs +1"}
	...
	sets.defense.BDT = {ammo="Staunch Tathlum +1",
		...
		body="Souv. Cuirass +1", hands="Souv. Handsch. +1", lring="Moonlight Ring", rring="Defending Ring",
	...
	sets.engaged = {ammo="Ginsen",
		...
		body="Souveran Cuirass +1", hands="Souv. Handsch. +1", lring="Moonlight Ring", rring="Moonlight Ring",
		back=gear.TP_jse_back, waist="Windbuffet Belt +1", legs="Souv. Diechlings +1", feet="Carmine Greaves +1"}

    sets.engaged.Acc = { ammo="Ginsen",
		head="Carmine Mask +1", neck="Sanctity Necklace", lear="Telos Earring", rear="Digni. Earring",
		body="Souveran Cuirass +1", hands="Souv. Handsch. +1", lring="Regal Ring", rring="Moonlight Ring",
	...
	sets.engaged.Tank = {ammo="Staunch Tathlum +1",
		...
		body="Souveran Cuirass +1", hands="Souv. Handsch. +1", lring="Moonlight Ring", rring="Defending Ring",
