...
function init_gear_sets()
	...
	sets.precast.JA['Jump'] = {ammo="Ginsen",
		head="Flam. Zucchetto +2",neck="Anu Torque",ear1="Sherida Earring",ear2="Telos Earring",
		 body="Ptero. Mail +3", hands="Vis. Fng. Gaunt. +3",ring1="Petrov Ring",rring="Niqmaddu Ring",
	...
	sets.weapons.Rhongomiant = {main="Rhongomiant", sub="Utu Grip"}
	sets.weapons.Gungnir = {main="Gungnir", sub="Utu Grip"}
	sets.weapons.ShiningOne = {main="Shining One", sub="Utu Grip"}
	sets.weapons.Ryunohige = {main="Ryunohige", sub="Utu Grip"}
