function user_setup()
	...
	-- Pet acc +25 TP Bonus 200
	gear.PHYKumbha1 = {name="Kumbhakarna", augments={'Pet: Accuracy+15 Pet: Rng. Acc.+15','Pet: "Dbl.Atk."+4 Pet: Crit.hit rate +4','Pet: TP Bonus+200',}}
	-- Pet acc +25 TP Bonus 200
	gear.PHYKumbha2 = {name="Kumbhakarna", augments={'Pet: Accuracy+18 Pet: Rng. Acc.+18','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+200',}}
	--
...
function init_gear_sets()
	...
	sets.precast.JA['Bestial Loyalty'] = {body="Mirke Wardecors", hands="Ankusa Gloves +3", feet="Armada Sollerets"} 
	...
	sets.precast.JA['Feral Howl'] = {ammo="Pemphredo Tathlum",
		...
		body="Ankusa Jackcoat +3", hands="Malignance Gloves", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.FC_jse_back, waist="Eschan Stone", legs="Malignance Trousers", feet="Malignance Boots"}
		
	-- MND Mod
	sets.precast.JA.Reward = {
		-- head="Stout Bonnet"  neck="Phalaina Locket",
		head="Malignance Chapeau", ear1="Domes. Earring", ear2="Lifestorm Earring",
		body="Totemic Jackcoat +1", hands="Malignance Gloves", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		-- waist="Klouskap Sash", 
	...
	sets.precast.JA.Charm = {
		...
		head="Totemic Helm +3", neck="Unmoving Collar +1", lear="Enchntr. Earring +1",
		-- Carb. Ring +1
		body="Ankusa Jackcoat +3", hands="Ankusa Gloves +3",
	...
	sets.precast.Flourish1 = {ammo="Pemphredo Tathlum",
		...
		head="Malignance Chapeau", neck="Sanctity Necklace", lear="Digni. Earring", rear="Enchntr. Earring +1",
		body="Ankusa Jackcoat +3", hands="Malignance Gloves", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.magic_ws_jse_back, waist="Eschan Stone", legs="Malignance Trousers", feet="Malignance Boots"}
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		back=gear.FC_jse_back, waist="Tempus Fugit", legs="Malignance Tights", feet="Malignance Boots"}
	...
	sets.midcast.FastRecast = {
		...
		body="Sacro Breastplate",hands="Malignance Gloves", ring1="Defending Ring", ring2="Prolix Ring",
		back=gear.FC_jse_back,waist="Tempus Fugit",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.precast.WS = {ammo="Ginsen", 
		...
		body="Ankusa Jackcoat +3", hands="Totemic Gloves +3", lring="Regal Ring", rring="Epaminondas's Ring",
		-- waist="Metalsinger Belt", 
		back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Ankusa Trousers +3", feet="Ankusa Gaiters +3"}
	...
	sets.precast.WS['Onslaught'] = {ammo="Ginsen", 
		-- neck="Bst. Collar +2", Thud Earring 
		head="Ankusa Helm +3", neck="Sanctity Necklace", lear="Cessance Earring", rear="Ishvara Earring",
		body="Tali'ah Manteel +2", hands="Totemic Gloves +3", lring="Epaminondas's Ring", rring="Ilabrat Ring",
		back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Ankusa Trousers +3", feet="Ankusa Gaiters +3"}
	...
	sets.precast.WS['Primal Rend'] = {ammo="Pemphredo Tathlum",
		...
		body="Sacro Breastplate",hands="Leyline Gloves",ring1="Shiva Ring +1",ring2="Epaminondas's Ring",
	...
	sets.AccMaxTP = {ear1="Digni. Earring",ear2="Telos Earring"}

	-- PET SIC & READY MOVES
	sets.midcast.Pet.WS = {main=gear.PHYKumbha1,sub=gear.PHYKumbha2,
		--  head="Emicho Coronet +1", neck="Beast Collar +2", ammo="Hesperiidae",
	...
	sets.midcast.Pet.SomeAcc = set_combine(sets.midcast.Pet.WS, {})--ammo="Voluspa Tathlum", waist="Klouskap Sash +1
	...
	sets.midcast.Pet.MagicReady = {main=gear.MABKumbha,sub=gear.PDTMABKumbha,ammo="Demonry Core",
		...
		body="Udug Jacket",hands="Nukumi Manoplas +1", ring1="Tali'ah Ring",ring2="Varar Ring +1",
	...
	sets.idle = {main="Izizoeksi",sub=gear.PDTMABKumbha, ammo="Staunch Tathlum",
		...
		-- Paguroidea Ring
		body="Sacro Breastplate",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Moonlight Ring",
		back=gear.FC_jse_back, waist="Flume Belt",legs="Meg. Chausses +2",feet="Malignance Boots"}
	
	sets.idle.DW = {main="Izizoeksi",sub=gear.PDTMABKumbha, ammo="Staunch Tathlum",
		-- Bathy Collar +1 Infused Earring Dawn Earring
		head="Meghanada Visor +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Genmei Earring",
		-- Paguroidea Ring
		body="Sacro Breastplate",hands="Meg. Gloves +2",ring1="Defending Ring",ring2="Moonlight Ring",
	...
	sets.idle.Pet = {main="Izizoeksi",sub="Kaidate",--ammo="Demonry Core",
		-- head="Anwig Salade",
		head="Meghanada Visor +2", neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Tot. Jackcoat +1",hands="Ankusa Gloves +3",ring1="Defending Ring",ring2="Moonlight Ring",
		back=gear.Pet_regen_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet="Ankusa Gaiters +3"}
	
	-- Pet Out No one engaged
	sets.idle.Pet.DW = {main="Izizoeksi",sub=gear.PDTMABKumbha,--ammo="Demonry Core",
		-- head="Anwig Salade",
		head="Meghanada Visor +2", neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
		body="Tot. Jackcoat +1",hands="Ankusa Gloves +3",ring1="Defending Ring",ring2="Moonlight Ring",
		back=gear.Pet_regen_jse_back,waist="Isa Belt",legs="Tali'ah Sera. +2",feet="Ankusa Gaiters +3"}
	...
	sets.idle.Pet.Engaged = {main="Skullrender",sub="Kaidate", Ammo="Voluspa Tathlum",
		-- neck="Beast Collar +2", 
		head="Tali'ah Turban +2",neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Domesticator Earring", 
	...
	sets.idle.Pet.Engaged.DW = {main="Skullrender",sub="Skullrender", Ammo="Voluspa Tathlum",
		-- neck="Beast Collar +2", 
		head="Tali'ah Turban +2",neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Domesticator Earring", 
		-- hands="Emicho Gauntlets +1" Path C
		body="An. Jackcoat +3", hands="Tali'ah Gages +2",ring1="Varar Ring +1",ring2="Varar Ring +1",
	...
	sets.defense.PetPDT = {--ammo="Demonry Core",
		...
		body="Tali'ah Manteel +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Moonlight Ring",
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		body="Tartarus Platemail",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Moonlight Ring",
		back=gear.Pet_regen_jse_back,waist="Flume Belt",legs="Tali'ah Sera. +2",feet="Malignance Boots"}
	...
	sets.engaged = {main=gear.PHYKumbha1, ammo="Ginsen",
		...
		-- Gere Ring
		body="Tali'ah Manteel +2",hands="Malignance Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
		back=gear.tp_jse_back,waist="Windbuffet Belt +1",legs="Malignance Tights",feet=gear.valorous_wsd_feet}
	...
	sets.engaged.Acc = {main=gear.PHYKumbha1, ammo="Ginsen",
		...
		-- Gere Ring
		body="Tali'ah Manteel +2",hands="Malignance Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
		back=gear.tp_jse_back,waist="Windbuffet Belt +1",legs="Malignance Tights",feet="Meg. Jam. +2"}
	...
	sets.engaged.PDT = {ammo="Staunch Tathlum",
		head="Malignance Chapeau", neck="Anu Torque",ear1="Dedition Earring",ear2="Sherida Earring",
		body="Tali'ah Manteel +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Moonlight Ring",
	...
	sets.engaged.DW = {main="Izizoeksi",sub="Hunahpu",ammo="Ginsen",
		head="Malignance Chapeau", neck="Anu Torque",lear="Ebani Earring", rear="Sherida Earring",
		-- Gere Ring
		body="Tali'ah Manteel +2",hands="Malignance Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
