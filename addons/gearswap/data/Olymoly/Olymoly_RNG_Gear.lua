...
function init_gear_sets()
	...
	-- +10 from Merits. Gastraphetes +10
	-- Need 60
	sets.precast.RA = {
		--neck="Scout's Gorget +2"
		head="Orion Beret +3",
		-- Oshosi Vest +1 Amini Caban +3 lring="Crepuscular Ring"
		body="Amini Caban +1", hands="Carmine Fin. Ga. +1",
		back=gear.snapshot_ranger_jse_back, waist="Yemaya Belt", legs="Orion Braccae +3", feet="Meg. Jam. +2"}
		
	sets.precast.RA.Flurry = set_combine(sets.precast.RA, {
		--  neck="Scout's Gorget +2"
		head="Orion Beret +3",
		-- Amini Caban +3 lring="Crepuscular Ring"
		body="Amini Caban +1", hands="Carmine Fin. Ga. +1",
		-- legs="Path D"
		back=gear.snapshot_ranger_jse_back, waist="Yemaya Belt", legs="Adhemar Kecks +1", feet="Meg. Jam. +2"})
	...
	sets.precast.RA.Flurry2 = set_combine(sets.precast.RA, {
		...
		body="Amini Caban +1", hands="Carmine Fin. Ga. +1",
		-- legs="Path D",
		back=gear.snapshot_ranger_jse_back, waist="Impulse Belt", legs="Adhemar Kecks +1", feet="Arcadian Socks +3"})
	...
	sets.precast.RA.Gastraphetes = {
		...
		-- Amini Caban +3
		body="Amini Caban +1", hands="Carmine Fin. Ga. +1",
		back=gear.snapshot_ranger_jse_back, waist="Impulse Belt",legs="Orion Braccae +3",feet="Meg. Jam. +2"}
	
	-- Need 35
	sets.precast.RA.Gastraphetes.Flurry = set_combine(sets.precast.RA, {
		-- neck="Scout's Gorget +2"
		head="Orion Beret +3",
		-- lring="Crepuscular Ring"
		body="Amini Caban +1", hands="Carmine Fin. Ga. +1",
		back=gear.snapshot_ranger_jse_back, waist="Yemaya Belt", legs="Adhemar Kecks +1", feet="Meg. Jam. +2"})
	...
	sets.precast.WS['Savage Blade'] = {
		-- Nyame Helm Scout's Gorget 
		head="Orion Beret +3", neck="Fotia Gorget", lear="Moonshade Earring", rear="Ishvara Earring",
		-- Nyame Mail Nyame Gauntlets
		body="Meg. Cuirie +2", hands="Meg. Gloves +2", lring="Regal Ring", ring2="Epaminondas's Ring",
		-- Nyame Flanchard Nyame Sollerets
		back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Arc. Braccae +3", feet=gear.herculean_ta_feet}
	...
	sets.precast.WS['Evisceration'] = {
		-- Scout's Gorget 
		head="Adhemar Bonnet +1", neck="Fotia Gorget", lear="Moonshade Earring", rear="Mache Earring +1",
	...
	sets.precast.WS['Jishnu\'s Radiance'].Acc = {
		head="Orion Beret +3", neck="Fotia Gorget", lear="Telos Earring", rear="Enervating Earring",
	...
	sets.precast.WS['Jishnu\'s Radiance'].HighAcc = {
		head="Orion Beret +3", neck="Iskur Gorget", lear="Telos Earring", rear="Enervating Earring",
		-- lring"Cacoethic Ring +1"
		body="Orion Jerkini +2", hands="Adhemar Wrist. +1", lring="Mummu Ring", ring2="Regal Ring",
		-- wais="K. Kachina Belt +1"
		back=gear.crit_ranger_jse_back, waist="Kwahu Kachina Belt", legs="Adhemar Kecks +1", feet="Orion Socks +3"}
    ...
    sets.midcast.RA.Acc = {
        ...
        body="Nisroch Jerkin",hands="Malignance Gloves", ring1="Regal Ring",ring2="Ilabrat Ring",
		-- K. Kachina Belt +1
        back=gear.tp_ranger_jse_back,waist="Kwahu Kachina Belt",legs="Adhemar Kecks +1", feet="Orion Socks +3"}
	...
	sets.buff.Barrage = set_combine(sets.midcast.RA.Acc, {
        head="Orion Beret +3",neck="Iskur Gorget",ear1="Telos Earring",ear2="Enervating Earring",
		-- rring="Caooethic Ring +1",
        body="Orion Jerkin +3",hands="Orion Bracers +3", ring1="Regal Ring",ring2="Ilabrat Ring",
        back=gear.tp_ranger_jse_back,waist="Kwahu Kachina Belt",legs="Adhemar Kecks +1",feet="Orion Socks +3"})
    ...
    sets.engaged.Acc = {
		...
		body="Malignance Tabard",hands="Malignance Gloves",lring="Petrov Ring", rring="Ilabrat Ring",
	...
	sets.engaged.HighAcc = {
		...
		back=gear.tp_jse_back, waist="Tempus Fugit", legs="Malignance Tights", feet="Malignance Boots"}
	sets.engaged.KC = {
		head="Malignance Chapeau", neck="Iskur Gorget",  lear="Dedition Earring", rear="Odr Earring", 
	...
	sets.engaged.DW.HighAcc = {
		...
		back=gear.DW_jse_back, waist="Tempus Fugit", legs="Malignance Tights", feet="Malignance Boots"}
	sets.engaged.DW.KC = {
		head="Malignance Chapeau", neck="Iskur Gorget",  lear="Dedition Earring", rear="Eabani Earring", 
		body="Malignance Tabard",hands="Malignance Gloves", lring="Chirich Ring +1", rring="Chirich Ring +1",
		-- Olseni Belt 
		back=gear.DW_jse_back, waist="Tempus Fugit", legs="Malignance Tights", feet="Malignance Boots"}
