...
function user_setup()
    ...
    state.HybridMode:options('Normal','SubtleBlow','DT','Reraise')
	...
	state.Weapons:options('GreatKatana','Amanomurakumo','Omen','ShiningOne','ProcWeapon','Bow','Yoichinoyumi') -- 'Masamune', 'Dojikiri'
...
function init_gear_sets()
    ...
    sets.precast.JA.Meditate = {head="Wakido Kabuto +3",hands="Sakonji Kote +3",back=gear.stp_jse_back}
    ...
    sets.precast.WS = {ammo="Knobkierrie",
        ...
        -- Nyame Gauntlets
		body="Sakonji Domaru +3",hands="Wakido Kote +3", ring1="Regal Ring", ring2="Niqmaddu Ring",
		-- Nyame Sollerets
   ...
   sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {ammo="Knobkierrie",
    ...
    sets.precast.WS['Tachi: Ageha'] = {ammo="Pemphredo Tathlum",
		...
		body="Sakonji Domaru +3", hands="Flam. Manopolas +2", lring="Stikini Ring +1", ring2="Metamor. Ring +1",
    ...
    sets.precast.WS['Namas Arrow'].SomeAcc = set_combine(sets.precast.WS['Namas Arrow'], {})
    ...
    sets.precast.WS['Namas Arrow'].Fodder = set_combine(sets.precast.WS['Namas Arrow'], {})
	...
	sets.precast.WS['Impluse Drive'] = {ammo="Knobkierrie",
		...
		body="Sakonji Domaru +3",hands="Wakido Kote +3", ring1="Epaminondas's Ring", ring2="Niqmaddu Ring",
	...
	sets.precast.WS['Stardiver'] = {ammo="Knobkierrie", --ammo="Coiste Bodhar",
		-- head="Mpaca's Cap", ear2="Schere Earring",
		head="Flam. Zucchetto +2", neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Tatena. Harama. +1", hands="Ryuo Tekko +1",  ring1="Regal Ring", ring2="Niqmaddu Ring",
	...
	sets.precast.WS['Stardiver'].SomeAcc = set_combine(sets.precast.WS, {ammo="Knobkierrie", --ammo="Coiste Bodhar",
		-- head="Mpaca's Cap", ear2="Schere Earring",
		head="Flam. Zucchetto +2", neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Tatena. Harama. +1", hands="Ryuo Tekko +1", ring1="Regal Ring", ring2="Niqmaddu Ring",
		-- legs="Mpaca's Hose", feet="Valorous Greaves" Crit +4
	...
	sets.precast.WS['Stardiver'].Acc = set_combine(sets.precast.WS,   {ammo="Knobkierrie", --ammo="Coiste Bodhar",
		-- head="Mpaca's Cap", ear2="Schere Earring",
		head="Flam. Zucchetto +2", neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Tatena. Harama. +1", hands="Ryuo Tekko +1", ring1="Regal Ring", ring2="Niqmaddu Ring",
		-- legs="Mpaca's Hose", feet="Valorous Greaves" Crit +4
	...
	sets.precast.WS['Stardiver'].FullAcc = set_combine(sets.precast.WS,   {ammo="Knobkierrie", --ammo="Coiste Bodhar",
		-- head="Mpaca's Cap", ear2="Schere Earring",
		head="Flam. Zucchetto +2", neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Tatena. Harama. +1", hands="Ryuo Tekko +1",  ring1="Regal Ring", ring2="Niqmaddu Ring",
		-- legs="Mpaca's Hose", feet="Valorous Greaves" Crit +4
	...
	sets.precast.WS['Stardiver'].Fodder = set_combine(sets.precast.WS,  {ammo="Knobkierrie", --ammo="Coiste Bodhar",
		-- head="Mpaca's Cap", ear2="Schere Earring",
		head="Flam. Zucchetto +2", neck="Fotia Gorget", ear1="Moonshade Earring",ear2="Brutal Earring",
		body="Tatena. Harama. +1", hands="Ryuo Tekko +1",  ring1="Regal Ring", ring2="Niqmaddu Ring",
		-- legs="Mpaca's Hose", feet="Valorous Greaves" Crit +4
    ...
    -- Ranged gear
    sets.midcast.RA = {-- neck="Sam. Nodowa +2",
		head="Sakonji Kabuto +3", lear="Telos Earring", rear="Crep. Earring", 
		-- rring="Crepuscular Ring", 
		body="Wakido Domaru +2", hands="Volte Mittens", lring="Regal Ring",
		waist="Yemaya belt", legs="Wakido Haidate +3", feet="Waki. Sune-Ate +2"}

    sets.midcast.RA.Acc = {-- neck="Sam. Nodowa +2",
		head="Sakonji Kabuto +3", lear="Telos Earring", rear="Crep. Earring", 
		-- rring="Crepuscular Ring", 
		body="Wakido Domaru +2", hands="Volte Mittens", lring="Regal Ring",
		waist="Yemaya belt", legs="Wakido Haidate +3", feet="Waki. Sune-Ate +2"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        body="Wakido Domaru +2", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
		-- legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Wakido Haidate +3", feet="Flam. Gambieras +2"}
    ...
    sets.engaged = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", 
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", 
        back=gear.stp_jse_back, waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.SomeAcc = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", 
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		-- Kasuga Haidate +3
        back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Tatena. Haidate +1", feet="Tatena. Sune. +1"}
    sets.engaged.Acc = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", 
		body="Sakonji Domaru +3", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Regal Ring",
		-- Kasuga Haidate +3
        back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Tatena. Haidate +1", feet="Tatena. Sune. +1"}
    sets.engaged.FullAcc = {ammo="Ginsen", -- ammo="Amar Cluster",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", 
		body="Sakonji Domaru +3", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Regal Ring",
		-- Kasuga Haidate +3
        back=gear.stp_jse_back, waist="Ioskeha Belt +1", legs="Tatena. Haidate +1", feet="Wakido Sune. +3"}
    sets.engaged.Fodder = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", 
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", legs="Ken. Hakama +1", 
        back="Takaha Mantle", waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    
	sets.engaged.SubtleBlow = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		-- head="Ken. Jinpachi +1",  ear1="Schere Earring", ear2="Digni. Earring",
		head="Flam. Zucchetto +2", neck="Bathy Choker",ear1="Cessance Earring", ear2="Telos Earring", 
		-- 
		body="Dagon Breast.", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  Mpaca's Hose
        back=gear.stp_jse_back, waist="Sarissapho. Belt",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.SomeAcc.SubtleBlow = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		-- head="Ken. Jinpachi +1",  ear1="Schere Earring", ear2="Digni. Earring",
		head="Flam. Zucchetto +2", neck="Bathy Choker",ear1="Cessance Earring", ear2="Telos Earring", 
		-- 
		body="Dagon Breast.", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  Mpaca's Hose
        back=gear.stp_jse_back, waist="Sarissapho. Belt",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.Acc.SubtleBlow = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		-- head="Ken. Jinpachi +1",  ear1="Schere Earring", ear2="Digni. Earring",
		head="Flam. Zucchetto +2", neck="Bathy Choker",ear1="Cessance Earring", ear2="Telos Earring", 
		-- 
		body="Dagon Breast.", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  Mpaca's Hose
        back=gear.stp_jse_back, waist="Sarissapho. Belt",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.FullAcc.SubtleBlow = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		-- head="Ken. Jinpachi +1",  ear1="Schere Earring", ear2="Digni. Earring",
		head="Flam. Zucchetto +2", neck="Bathy Choker",ear1="Cessance Earring", ear2="Telos Earring", 
		-- 
		body="Dagon Breast.", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  Mpaca's Hose
        back=gear.stp_jse_back, waist="Sarissapho. Belt",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.Fodder.SubtleBlow = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		-- head="Ken. Jinpachi +1",  ear1="Schere Earring", ear2="Digni. Earring",
		head="Flam. Zucchetto +2", neck="Bathy Choker", ear1="Cessance Earring", ear2="Telos Earring", 
		-- 
		body="Dagon Breast.", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
	...
	sets.engaged.DT = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", hands="Ken. Tekko +1",
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", feet="Ken. Sune-ate +1" 
        back="Takaha Mantle", waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.SomeAcc.DT = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", hands="Ken. Tekko +1",
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", feet="Ken. Sune-ate +1" 
        back="Takaha Mantle", waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.Acc.DT = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", hands="Ken. Tekko +1",
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", feet="Ken. Sune-ate +1" 
        back="Takaha Mantle", waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.FullAcc.DT = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", hands="Ken. Tekko +1",
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
		--  waist="Sweordfaetels +1", feet="Ken. Sune-ate +1" 
        back="Takaha Mantle", waist="Windbuffet Belt +1",legs="Tatena. Haidate +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.Fodder.DT = {ammo="Ginsen", -- ammo="Coiste Bodhar",
		-- head="Kasuga Kabuto +3", neck="Sam. Nodowa +2", ear1="Schere Earring", ear2="Kasuga Earring +2",
		head="Flam. Zucchetto +2", neck="Ganesha Mala", ear1="Cessance Earring", ear2="Telos Earring", 
		-- body="Kasuga Domaru +3", body="Ken. Samue +1", hands="Ken. Tekko +1",
		body="Sakonji Domaru +3", hands="Tatena. Gote +1", ring1="Chirich Ring +1", ring2="Niqmaddu Ring",
...
--[[Right now Adoulin sets are the same as non-Adoulin.
	sets.engaged.Adoulin = {ammo="Ginsen",
        ...
        back=gear.stp_jse_back,waist="Ioskeha Belt +1",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
	...
	sets.weapons.Yoichinoyumi = {main="Amanomurakumo", sub="Utu Grip", range="Yoichinoyumi", ammo="Eminent Arrow"}
	
	-- Buff sets
	sets.Cure_Received = {hands="Buremte Gloves",waist="Gishdubar Sash",legs="Flamma Dirs +2"}
	sets.buff.Doom = set_combine(sets.buff.Doom, {})
	sets.buff.Sleep = {neck="Vim Torque +1"}
	sets.buff.Hasso = {hands="Wakido Kote +3"} -- Kasuga Haidate +3
...
autows_list = {
		...
		['ShiningOne']='Impluse Drive',
		['Omen']='Tachi: Jinpu',
		['Bow']='Tachi: Fudo',
		['Yoichinoyumi']='Apex Arrow',
		['ProcKatana']='Blade: Ei',
