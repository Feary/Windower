function user_job_setup()
	...
	state.Weapons:options('Godhands','Karambit','Staff','Spharai','Vere','Godhands','Barehanded','ProcStaff','ProcClub','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana')
...
function init_gear_sets()
	...
	-- HP VIT
	sets.precast.JA['Chakra'] = {ammo="Tantra Tathlum",--ammo="Aurgelmir Orb +1",
		-- Genmei Kabuto
		head="Malignance Chapeau", neck="Unmoving Collar +1", lear="Handler's Earring +1", rear="Tuisto Eaerring",
		body="Anch. Cyclas +3", hands="Hes. Gloves +3", lring="Gelatinous Ring +1", ring2="Regal Ring",
		back=gear.chakra_jse_back, waist="Latria Sash", legs="Tatena. Haidate +1",feet="Tatena. Sune. +1"}
	...
	sets.idle = {ammo="Staunch Tathlum +1",
		...
		body="Ashera Harness",hands="Hizamaru Kote +2",ring1="Defending Ring",ring2="Gelatinous Ring +1",
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.defense.MEVA = {aammo="Staunch Tathlum +1",
		-- Ken. Jinpachi +1   
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Sanare Earring",ear2="Ebani Earring",
		-- Ken. Samue +1 Ken. Tekko +1
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Gelatinous Ring +1",
	...
	sets.engaged = {ammo="Ginsen",
		...
		-- Gere Ring
		body="Malignance Tabard", hands="Adhemar Wrist. +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
	...
	sets.engaged.PDT = {ammo="Staunch Tahtlum +1",
		--  Mnk. Nodowa +2 
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt 
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.SomeAcc.PDT = {ammo="Staunch Tahtlum +1",
		-- Mnk. Nodowa +2 
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt   
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.Acc.PDT = {ammo="Staunch Tahtlum +1",
		-- Mnk. Nodowa +2
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt 
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.FullAcc.PDT = {ammo="Staunch Tahtlum +1",
		--  Mnk. Nodowa +2 
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt   
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.Fodder.PDT = {ammo="Staunch Tahtlum +1",
		--  Mnk. Nodowa +2 
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Niqmaddu Ring",
		-- Moonlight Belt
	...
	-- Verethragna
	sets.weapons.Vere = {main="Godhands"}
	sets.weapons.Barehanded = {main=empty}
	sets.weapons.Staff = {main="Malignance Pole", sub="Flanged Grip"}
	sets.weapons.Club = {main="Loxotic Mace +1", sub=empty}
