...
-- Body
-- {name="Taeon Tabard", augments={'"Fast Cast"+5','Phalanx +3',}
gear.taeon_body_Fastcast = "Taeon Tabard"
...
--------------------------------------
	...
	gear.grioavolr_fc_staff = "Grioavolr"
...
-- Head
	gear.herculean_fc_head = { name="Herculean Helm", augments={'CHR+2','Damage taken-1%','"Fast Cast"+3','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}
	-- gear.herculean_phalanx_head = {}
...
-- Body
	-- Phalanx 4 or 5 only
	gear.herculean_phalanx_body = {name="Herculean Vest", augments={'AGI+5','Enmity-6','Phalanx +5','Mag. Acc.+18 "Mag.Atk.Bns."+18',}}
...
-- Hands
	...
	gear.herculean_fc_hands = {name="Herculean Gloves", augments={'Accuracy+13','"Fast Cast"+3','Mag. Acc.+19 "Mag.Atk.Bns."+19',}}
-- Legs
	--gear.herculean_phalanx_legs = {}
	gear.herculean_fc_legs = { name="Herculean Trousers", augments={'Magic burst dmg.+8%','"Fast Cast"+5','Weapon skill damage +1%','Accuracy+8 Attack+8','Mag. Acc.+15 "Mag.Atk.Bns."+15',}}
	gear.herculean_refresh_legs = { name="Herculean Trousers", augments={'"Waltz" potency +7%','Accuracy+5','"Refresh"+1','Accuracy+19 Attack+19','Mag. Acc.+3 "Mag.Atk.Bns."+3',}}
...
-- Feet
	gear.herculean_fc_feet = { name="Herculean Boots", augments={'Attack+9','STR+10','"Fast Cast"+4','Accuracy+2 Attack+2',}}
...
-- Body 
	gear.merlinic_phalanx_body = {name="Merlinic Jubbah", augments={'MND+7','Phalanx +3','Accuracy+14 Attack+14','Mag. Acc.+3 "Mag.Atk.Bns."+3',}}
...
-- Feet 
	-- Drain/Aspir +10
	gear.merlinic_aspir_feet = {name="Merlinic Crackows", augments={'STR+12','MND+1','"Refresh"+2','Accuracy+15 Attack+15','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
	-- FC +7
