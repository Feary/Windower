...
function user_job_setup()
	...
	state.Weapons:options('GreatKatana','Polearm','Omen','Quint','Bow','ProcKatana','ProcPolearm') --'Dojikiri',
	...
	gear.Magicws_jse_back = {name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	-- STR acc DBL
	gear.wsdbl_jse_back = 	{name="Smertrios's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Phys. dmg. taken-10%',}}
	-- agi range stp
	gear.ra_jse_back = 	{name="Smertrios's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Store TP"+10','Phys. dmg. taken-10%',}}
...
function init_gear_sets()
    ...
    sets.precast.Step = {ammo="Hasty Pinion",
		-- ear1="Digni. Earring", 
		head="Flam. Zucchetto +2", neck="Combatant's Torque", lear="Mache Earring +1", rear="Telos Earring",
		-- lring="Regal Ring", rring="Niqmaddu Ring",
		body="Sakonji Domaru +3", hands="Wakido Kote +3", ring1="Chirich Ring +1", ring2="Chirich Ring +1", 
		back=gear.dbl_jse_back, waist="Ioskeha Belt",legs="Wakido Haidate +3", feet="Flam. Gambieras +2"}
    -- Macc
	sets.precast.JA['Violent Flourish'] = {ammo="Pemphredo Tathlum",
		-- ear1="Digni. Earring",
        head="Flam. Zucchetto +2", neck="Combatant's Torque", lear="Mache Earring +1", rear="Mache Earring +1",
		body="Sakonji Domaru +3", hands="Wakido Kote +3", ring1="Stikini Ring", ring2="Stikini Ring", 
        back=gear.dbl_jse_back, waist="Ioskeha Belt", legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}

    -- Waltz set (chr and vit)
    sets.precast.Waltz = {
		head="Flam. Zucchetto +2", neck="Sanctity Necklace",
        body="Sakonji Domaru +3", hands="Wakido Kote +3",
        waist="Chaac Belt", legs="Wakido Haidate +3", feet="Flam. Gambieras +2"}
    ...
    sets.precast.WS = {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2",ar1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
	...
	sets.precast.WS.SomeAcc = set_combine(sets.precast.WS, {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring",ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
		-- Nyame Sollerets
        back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Wakido Haidate +3",feet="Flam. Gambieras +2"})
	
	sets.precast.WS.Acc = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",  
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring",ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS.FullAcc = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS.Fodder = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
    ...
    sets.precast.WS['Tachi: Ageha'] =  {--ammo="Pemphredo Tathlum",
		--  ear2="Digni. Earring", 
		head="Flam. Zucchetto +2", neck="Sanctity Necklace", ear1="Gwati Earring", ear2="Telos Earring",
		body="Sakonji Domaru +3",hands="Flam. Manopolas +2", lring="Stikini Ring",  ring2="Metamor. Ring +1",
        back=gear.ws_jse_back, waist="Eschan Stone", legs="Flamma Dirs +2", feet="Flam. Gambieras +2"}
		
    sets.precast.WS['Tachi: Hobaku'] = {}
		
    sets.precast.WS['Tachi: Jinpu'] = set_combine(sets.precast.WS, {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
		-- Nyame Sollerets
        back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Wakido Haidate +3",feet="Flam. Gambieras +2"})
	sets.precast.WS['Tachi: Jinpu'].Omen = set_combine(sets.precast.WS, {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	-- Polearm 
	sets.precast.WS['Impluse Drive'] = {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- body="Nyame Mail" hands="Nyame Gauntlets", ring1="Niqmaddu Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
		--legs="Nyame Flanchard", feet="Nyame Sollerets"
        back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
   
	sets.precast.WS['Impluse Drive'].SomeAcc = set_combine(sets.precast.WS, {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS['Impluse Drive'].Acc = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS['Impluse Drive'].FullAcc = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring",ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS['Impluse Drive'].Fodder = set_combine(sets.precast.WS,  {ammo="Crepuscular Pebble", --ammo="Knobkierrie",
		-- head="Mpaca's Cap",
		head="Flam. Zucchetto +2",  neck="Sam. Nodowa +2", ear1="Moonshade Earring", ear2="Thud Earring",
        -- Nyame Gauntlets ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3", hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
	...
	sets.precast.WS['Stardiver'] = {--ammo="Coiste Bodhar",
        ...
        -- body="Tatena. Harama. +1" hands="Ryou Tekko +1", ring1="Niqmaddu Ring", ring2="Regal Ring",
		body="Sakonji Domaru +3",hands="Wakido Kote +3", lring="Rajas Ring", rring="Epaminondas's Ring",
    ...
    -- Ranged gear
    sets.midcast.RA = {
		head="Sakonji Kabuto +3",  neck="Sam. Nodowa +2", lear="Telos Earring", rear="Crep. Earring", 
    ...
    sets.idle = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		-- lear="Genmei Earring", 
        ...
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
		
    sets.idle.Reraise = set_combine(sets.idle, sets.Reraise)

    sets.idle.Weak = {--ammo="Staunch Tathlum +1",
		-- lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Gelatinous Ring +1", ring2="Defending Ring",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    ...
    -- Defense sets
    sets.defense.PDT = {ammo="Crepuscular Pebble",-- ammo="Staunch Tathlum +1",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring", rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Gelatinous Ring +1", ring2="Defending Ring",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}

    sets.defense.PDTReraise = set_combine(sets.defense.PDT, sets.Reraise)
		
    sets.defense.MDT = {ammo="Crepuscular Pebble",-- ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring", rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Gelatinous Ring +1", ring2="Defending Ring",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    ...
    sets.defense.MEVA = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		head="Ken. Jinpachi +1",  neck="Loricate Torque +1", lear="Odnowa Earring", rear="Odnowa Earring +1",
		body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Gelatinous Ring +1", ring2="Defending Ring",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    ...
    sets.engaged = {ammo="Crepuscular Pebble", -- ammo="Aurgelmir Orb +1",
		--  ear1="Cessance Earring", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", lear="Mache Earring +1", ear2="Telos Earring", 
		-- ring2="Niqmaddu Ring"
		body="Ken. Samue +1", hands="Wakido Kote +3", ring1="Flamma Ring", ring2="Chirich Ring +1",
        back=gear.dbl_jse_back, waist="Windbuffet Belt +1", legs="Ken. Hakama +1", feet="Ryuo Sune-ate +1"}
    sets.engaged.SomeAcc = {ammo="Crepuscular Pebble", -- ammo="Aurgelmir Orb +1",
		--  ear2="Dedition Earring", ear2="Brutal Earring", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", lear="Mache Earring +1", ear2="Telos Earring", 
		-- ring2="Niqmaddu Ring"
		 body="Ken. Samue +1", hands="Wakido Kote +3", ring1="Flamma Ring", ring2="Chirich Ring +1",
        back=gear.dbl_jse_back, waist="Windbuffet Belt +1", legs="Ken. Hakama +1", feet="Flam. Gambieras +2"}
    sets.engaged.Acc = {ammo="Crepuscular Pebble", -- ammo="Aurgelmir Orb +1",
		--   ear2="Digni. Earring", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", lear="Mache Earring +1", ear2="Telos Earring", 
		--  ring2="Niqmaddu Ring"
		body="Ken. Samue +1",  hands="Wakido Kote +3", ring1="Flamma Ring", ring2="Chirich Ring +1",
		-- waist="Ioskeha Belt +1",
        back=gear.dbl_jse_back,waist="Ioskeha Belt", legs="Ken. Hakama +1", feet="Flam. Gambieras +2"}
    sets.engaged.FullAcc = {ammo="Crepuscular Pebble", -- ammo="Aurgelmir Orb +1",
		-- ear2="Dedition Earring", ear2="Brutal Earring", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", lear="Mache Earring +1", ear2="Telos Earring", 
		-- ring2="Regal Ring"
		body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Flamma Ring", ring2="Chirich Ring +1",
		-- waist="Ioskeha Belt +1",
        back=gear.dbl_jse_back,waist="Ioskeha Belt", legs="Wakido Haidate +3", feet="Flam. Gambieras +2"}
    sets.engaged.Fodder = {ammo="Crepuscular Pebble", -- ammo="Coiste Bodhar",
		--  ear1="Telos Earring", ear2="Cessance Earring", ear1="Schere Earring", ear2="Dedition Earring", 
		head="Flam. Zucchetto +2", neck="Sam. Nodowa +2", lear="Mache Earring +1", ear2="Telos Earring", 
		--  ring2="Niqmaddu Ring"
		body="Ken. Samue +1", hands="Wakido Kote +3", ring1="Flamma Ring", ring2="Chirich Ring +1",
        back=gear.dbl_jse_back, waist="Windbuffet Belt +1", legs="Ken. Hakama +1", feet="Ryuo Sune-ate +1"}
    
	sets.engaged.PDT = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.SomeAcc.PDT = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.Acc.PDT = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.FullAcc.PDT = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
	--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.Fodder.PDT = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
	
	sets.engaged.DTLite = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
	sets.engaged.SomeAcc.DTLite = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.Acc.DTLite = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.FullAcc.DTLite = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
    sets.engaged.Fodder.DTLite = {ammo="Crepuscular Pebble",--ammo="Staunch Tathlum +1",
		--  lear="Genmei Earring",
		head="Ken. Jinpachi +1", neck="Loricate Torque +1", lear="Odnowa Earring",  rear="Odnowa Earring +1",
        body="Wakido Domaru +3", hands="Wakido Kote +3", ring1="Defending Ring", ring2="Gelatinous Ring +1",
        back=gear.dbl_jse_back, waist="Flume Belt", legs="Ken. Hakama +1", feet="Ken. Sune-ate +1"}
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    sets.engaged.Adoulin.FullAcc = {ammo="Ginsen",
        head="Flam. Zucchetto +2",neck="Combatant's Torque",ear1="Mache Earring +1",ear2="Telos Earring",
        body="Kasuga Domaru +1",hands="Wakido Kote +3",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	-- Weapons sets
	sets.weapons.Omen = {main="Soboro Sukehiro",sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.GreatKatana = {main="Umaru",sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.Quint = {main="Quint Spear",sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.Polearm = {main="Shining One",sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.ProcWeapon = {main="Soboro Sukekiro",sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.Bow = {main="Soboro Sukekiro",sub="Duplus Grip",range="Cibitshavore",ammo="Eminent Arrow"} -- sub="Utu Grip"
	sets.weapons.ProcKatana = {main="Soboro Sukehiro", sub="Duplus Grip"} -- sub="Utu Grip"
	sets.weapons.ProcPolearm = {main="Quint Spear", sub="Duplus Grip"} -- sub="Utu Grip"
	
	-- Buff sets
	sets.Cure_Received = {hands="Buremte Gloves",waist="Gishdubar Sash",legs="Wakido Haidate +3"}
	sets.buff.Doom = set_combine(sets.buff.Doom, {})
	sets.buff.Sleep = {neck="Vim Torque +1"}
	sets.buff.Hasso = {hands="Wakido Kote +3"} -- legs="Kasuga Haidate +2"
...
autows_list = {
		['GreatKatana']='Tachi: Fudo',
		['Polearm']='Impluse Drive',
		['Omen']='Tachi: Jinpu',
		['Quint']='Double Thrust',
		['Bow']='Apex Arrow',
		['ProcKatana']='Blade: Ei',
