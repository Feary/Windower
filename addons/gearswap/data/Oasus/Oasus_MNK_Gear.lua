function user_job_setup()
	...
	state.Weapons:options('Kaja','Staff','Club','ProcStaff','ProcClub','Barehanded','ProcSword','ProcGreatSword','ProcScythe','ProcPolearm','ProcGreatKatana')
	...
	-- INT Macc WSD
	gear.Magic_WS_jse_back = 	{name="Segomo's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
	gear.crit_jse_back =		{name="Segomo's Mantle", augments={'STR+20','Accuracy+20 Attack+20','Crit.hit rate+10',}}
	gear.FC_jse_back = 			{name="Segomo's Mantle", augments={'MND+20','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10',}}
    gear.Chakra_jse_back =		{name="Segomo's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','Weapon skill damage +10%',}}
	gear.chi_jse_back = 		{name="Segomo's Mantle", augments={'MND+20','Eva.+20 /Mag. Eva.+20','"Fast Cast"+10'}}
...
function init_gear_sets()
	...
	sets.precast.JA['Focus'] = {head="Anch. Crown +1"}
	...
	sets.precast.JA['Chi Blast'] = {hands="Anch. Gloves +1"}
	
	sets.precast.JA['Chakra'] = {
		-- Genmei Kabuto  Handler's Earring +1
		head="Malignance Chapeau", neck="Unmoving Collar +1", rear="Tuisto Earring",
		--  Hes. Gloves +3
		body="Anch. Cyclas +1", hands="Hes. Gloves +3", ring1="Gelatinous Ring +1", ring2="Niqmaddu Ring",
		-- Tatenshi Haidate +1 Bhikku Gaiters +3
		back=gear.Chakra_jse_back, waist="Latria Sash", legs="Hiza. Hizayoroi +2", feet="Hiza. Sune-Ate +2"}
	...
	sets.precast.Step = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		-- Malignance Gloves 
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
		-- Moonlight Belt
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
		
	sets.precast.Flourish1 = {ammo="Ginsen", -- Staunch Tathlum +1
		--  Mnk. Nodowa +2 Telos Earring
	...
	sets.precast.FC = {ammo="Sapience Orb",
		...
		body="Taeon Tabard",hands="Leyline Gloves",ring1="Lebeche Ring",ring2="Kishar Ring",
	...
	sets.precast.WS = {ammo="Knobkierrie",
		...
		body=gear.herculean_wsd_body,hands="Anch. Gloves +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
	...
	sets.precast.WS['Howling Fist']    = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		...
		back=gear.Chakra_jse_back,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +2"})
	...
	sets.precast.WS["Ascetic's Fury"]  = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		-- Adhemar Bonnet +1
		head="Mummu Bonnet +2",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Sherida Earring",
		--  Or Ken. Samue +1 Ryou Tekko +1 ring2="Gere Ring", 
		body="Anch. Cyclas +1",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- Moonbow Belt +1 Ken. Hakama +1 Ken. Sune-Ate +1
		back=gear.Chakra_jse_back,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +2"})
	...
	sets.precast.WS['Tornado Kick']    = set_combine(sets.precast.WS, {ammo="Knobkierrie",
		...
		body="Mummu Jacket +2",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- Ken. Hakama +1 
		back=gear.Chakra_jse_back,waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet="Anch. Gaiters +1"})
	...
	sets.precast.WS['Cataclysm'] = {ammo="Pemphredo Tathlum",
		...
		-- Nyame Mail
		body="Samnuha Coat", hands="Leyline Gloves",ring1="Archon Ring", ring2="Metamor. Ring +1",
		-- Nyame Flanchard Nyame Sollerets
		back=gear.Magic_WS_jse_back,waist="Orpheus's Sash", legs="Malignance Tights", feet="Mummu Gamash. +2"}
	
	sets.precast.WS['Shell Crusher'] = set_combine(sets.precast.WS, {ammo="Pemphredo Tathlum",
		--  Bhikku Crown +1 Moonlight Necklace Digni. Earring Crep. Earring 
		head="Malignance Chapeau",neck="Sanctity Necklace",ear1="Enchntr. Earring +1",ear2="Gwati Earring",
		-- Bhikku Cyclasa +3 Bhikku Gloves +3
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Stikini Ring +1",ring2="Metamor. Ring +1",
		-- Bhikku Hose +3 Bhikku Gaiters +3
		back=gear.Magic_WS_jse_back,waist="Acuity Belt +1",legs="Malignance Tights",feet="Malignance Boots"})
	...
	sets.midcast.FastRecast = {ammo="Sapience Orb",
		...
		body="Malignance Tabard",hands="Leyline Gloves",ring1="Gelatinous Ring +1",ring2="Prolix Ring",
	...
	-- Idle sets
	sets.idle = {ammo="Crepuscular Pebble",-- Staunch Tathlum +1
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
		body="Malignance Tabard",hands="Hizamaru Kote +2",ring1="Gelatinous Ring +1",ring2="Defending Ring",
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}

	sets.idle.Weak = {ammo="Crepuscular Pebble",-- Staunch Tathlum +1
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Odnowa Earring +1",
		body="Malignance Tabard",hands="Hizamaru Kote +2",ring1="Gelatinous Ring +1",ring2="Defending Ring",
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	-- Defense sets
	sets.defense.PDT = {ammo="Crepuscular Pebble",-- Staunch Tathlum +1
		-- Ken. Jinpachi +1 
		head="Malignance Chapeau",neck="Warder's Charm +1",ear1="Sanare Earring",ear2="Ebani Earring",
		-- Ken. Samue +1 Ken. Tekko +1 
		body="Malignance Tabard",hands="Hizamaru Kote +2",ring1="Gelatinous Ring +1",ring2="Defending Ring",
		-- Ken. Hakama +1 Ken. Sune-Ate +1
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
		
	sets.defense.HP = {ammo="Crepuscular Pebble",-- Staunch Tathlum +1
		-- Ken. Jinpachi +1 
		head="Mummu Bonnet +2",neck="Warder's Charm +1", ear1="Sanare Earring",ear2="Ebani Earring",
		-- Ken. Samue +1 Ken. Tekko +1
		body="Hiza. Haramaki +2",hands="Hizamaru Kote +2",ring1="Gelatinous Ring +1",ring2="Shadow Ring",
		-- Ken. Hakama +1 Ken. Sune-Ate +1
	...
	-- Normal melee sets
	sets.engaged = {ammo="Ginsen", -- Coiste Bodhar Rank 25
		-- Ken. Jinpachi +1 Monk's nodowa +2  
		head="Malignance Chapeau", neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		--  hands="Malignance Gloves", rring="Gere Ring"
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- waist="Moonlight Belt +1", 
		back=gear.TP_jse_back,waist="Windbuffet Belt +1",legs="Hes. Hose +3",feet="Malignance Boots"}
	sets.engaged.SomeAcc = {ammo="Ginsen",
		-- Adhemar Bonnet +1 Moonlight Nodowa Telos Earring 
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		--  Gere Ring
		body="Mummu Jacket +2",hands="Mummu Wrists +2",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		-- waist="Moonlight Belt +1", legs="Hes. Hose +3",
		back=gear.TP_jse_back,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet="Anch. Gaiters +1"}
	...
	sets.engaged.PDT = {ammo="Ginsen", -- Coiste Bodhar
		-- Bhikku Crown +3 Mnk. Nodowa +2 Schere Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
		--  Mpaca's Doublet Mpaca's Gloves Gere Ring
		body="Malignance Tabard", hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
		-- Moonlight Belt +1 Bhikku Hose +3 Mpaca's Boots
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.SomeAcc.PDT = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		-- Malignance Gloves 
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
		-- Moonlight Belt   
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	sets.engaged.Acc.PDT = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		-- Malignance Gloves 
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
	...
	sets.engaged.FullAcc.PDT = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		-- Malignance Gloves 
		body="Malignance Tabard",hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
		-- Moonlight Belt  Malignance Tights 
		back=gear.TP_jse_back,waist="Black Belt",legs="Mummu Kecks +2",feet="Malignance Boots"}
	sets.engaged.Fodder.PDT = {ammo="Ginsen", -- Staunch Tathlum +1
		-- Mnk. Nodowa +2 Telos Earring
		head="Malignance Chapeau",neck="Anu Torque",ear1="Brutal Earring",ear2="Sherida Earring",
		-- Malignance Gloves 
		body="Ashera Harness",hands="Mummu Wrists +2",ring1="Gelatinous Ring +1",ring2="Niqmaddu Ring",
		-- Moonlight Belt  
		back=gear.TP_jse_back,waist="Black Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.weapons.Staff = {main="Xoanon", sub="Flanged Grip"}
