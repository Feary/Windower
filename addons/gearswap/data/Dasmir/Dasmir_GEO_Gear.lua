function user_setup()
	...
	gear.nuke_jse_back = 	{name="Nantosuelta's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10','Damage taken-5%',}}
	
	--gear.FC_jse_back = 		{name="Nantosuelta's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Pet: "Regen"+10','Pet: "Regen"+5',}} --{name="Nantosuelta's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','"Fast Cast"+10','Damage taken-5%',}}
	--{name="Nantosuelta's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','"Cure" potency +10%',}}
	gear.Cure_jse_back = 	"Solemnity Cape"
...
function init_gear_sets()
	...
	-- Current 76%
	sets.precast.FC = {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ranged="Dunna",
		head="Amalric Coif +1", neck="Voltsurge Torque", ear1="Enchntr. Earring +1", ear2="Malignance Earring",
		body="Zendik Robe", hands=gear.helios_hands_FC, ring1="Kishar Ring", ring2="Prolix Ring", 
		back="Fi Follet Cape +1", waist="Embla Sash", legs="Geomancy Pants +3", feet="Amalric Nails +1"}
	...
	sets.midcast.Geomancy = {main="Idris", sub="Genmei Shield", range="Dunna",
		...
		head="Vanya Hood", neck="Loricate Torque +1", lear="Odnowa Earring +1", rear="Malignance Earring", 
		-- Vanya Cuffs Path C
    ...
    sets.midcast.Cure = {main="Daybreak", sub="Sors Shield", range="Dunna",
		...
		-- Vanya Clogs
		back=gear.Cure_jse_back, waist="Shinjutsu-no-Obi +1", legs="Vanya Slops", feet="Regal Pumps"}
	...
	sets.midcast.Stun = {main="Idris", sub="Ammurapi Shield", range="Dunna",
		head="Geo. Galero +3", neck="Erra Pendant", lear="Regal Earring", rear="Malignance Earring",
		body="Geomancy Tunic +3", hands="Geo. Mitaines +3", lring="Stikini Ring +1", rring="Stikini Ring +1",
	...
	sets.midcast['Enfeebling Magic'] = {main="Idris", sub="Ammurapi Shield", range="Dunna",
		--  neck="Bagua Charm +2",
		head="Geo. Galero +3", neck="Erra Pendant", lear="Regal Earring", rear="Malignance Earring",
		body="Geomancy Tunic +3", hands="Regal Cuffs", lring="Kishar Ring", rring="Stikini Ring +1",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Idris", sub="Ammurapi Shield", range="Dunna",
		-- neck="Bagua Charm +2", 
		head="Geo. Galero +3", neck="Erra Pendant", lear="Regal Earring", rear="Malignance Earring",
		body="Geomancy Tunic +3", hands="Regal Cuffs", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.Cure_jse_back, waist="Acuity Belt +1", legs="Geomancy Pants +3", feet="Geo. Sandals +3"}
	...
	sets.idle = {main="Idris", sub="Genmei Shield", range="Dunna",
		head=gear.merlinic_refresh_head, neck="Loricate Torque +1", lear="Ethereal Earring", rear="Etiolation Earring",
		body="Shamash Robe", hands="Bagua Mitaines +3", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		back="Fi Follet Cape +1", waist="Shinjutsu-no-Obi +1", legs=gear.merlinic_refresh_legs, feet=gear.merlinic_refresh_feet}
	...
	sets.idle.Pet = set_combine(sets.idle.PDT, {main="Idris", sub="Genmei Shield", range="Dunna",
		-- Azimuth Hood +2 Bagua Charm +2
		head="Azimuth Hood +1", neck="Loricate Torque +1", lear="Ethereal Earring", rear="Etiolation Earring",
	...
	sets.idle.PDT.Pet = set_combine(sets.idle.PDT, {main="Idris", sub="Genmei Shield", range="Dunna",
		...
		head="Azimuth Hood +1", neck="Loricate Torque +1", lear="Odnowa Earring +1", rear="Etiolation Earring",
		body="Shamash Robe", hands="Geo. Mitaines +3", lring="Gelatinous Ring +1", rring="Defending Ring",
		back=gear.idle_jse_back, waist="Isa Belt", legs=gear.telchine_legs_Pet, feet="Bagua Sandals +3"})
	...
	sets.defense.MDT = {main="Idris",sub="Genmei Shield", range="Dunna",
		...
		back="Fi Follet Cape +1", waist="Shinjutsu-no-Obi +1", legs="Volte Hose", feet="Mallquis Clogs +2"}
	...
	sets.engaged.DW = {
		-- Nyame Helm
		head="Jhakri Coronal +2", neck="Sanctity Necklace", lear="Eabani Earring", rear="Suppanomimi",
		-- Nyame Mail Nyame Gauntlets 
	...
	sets.precast.WS = {
		-- Telos Earring
		head="Bagua Galero +3", neck="Fotia Gorget", lear="Mache Earring +1", rear="Regal Earring",
	...
	sets.precast.WS['Hexa Strike']= {  
		...
		head="Jhakri Coronal +2", neck="Sanctity Necklace", lear="Mache Earring +1", rear="Regal Earring",
	...
	sets.precast.WS['Realmrazer']= {
		...
		head="Jhakri Coronal +2", neck="Fotia Gorget",  lear="Mache Earring +1", rear="Regal Earring",
		body="Jhakri Robe +2", hands="Jhakri Cuffs +2", lring="Rufescent Ring",  rring="Petrov Ring",
		back=gear.nuke_jse_back, waist="Fotia Belt", legs="Jhakri Slops +2", feet="Jhakri Pigaches +2"}
	...
	-- Weapons sets
	sets.weapons.SingleWeapon = {main="Trial Wand", sub="Genmei Shield", ranged="Dunna"}
