...
function init_gear_sets()
    ...
    sets.precast.Step = {ammo="Hasty Pinion +1",
		--  rear="Telos Earring",
		head="Malignance Chapeau", neck="Sanctity Necklace", lear="Sherida Earring", rear="Suppanomimi",
		-- Malignance Tabard Malignance Gloves
		body="Mummu Jacket +2", hands="Mummu Wrists +2", lring="Regal Ring", rring="Ilabrat Ring",
		-- Malignance Tights 
		back=gear.stp_jse_back, waist="Kentarch Belt +1", legs="Mummu Kecks +2", feet="Malignance Boots"}
    ...
    sets.precast.FC = {
		...
		--   waist="Tempus Fugit", legs="Enif Cosciales", feet="Herculean Boots"
		back=gear.FC_jse_back, waist="Sarissapho. Belt",}
    ...
    sets.precast.WS = {ammo="Seeth. Bomblet +1",
		--neck="Caro Necklace",
		head="Pill. Bonnet +3", neck="Sanctity Necklace", lear="Sherida Earring", rear="Moonshade Earring",
		body="Plunderer's Vest +3", hands="Meg. Gloves +2", ring1="Regal Ring", ring2="Ilabrat Ring",
		back=gear.wsd_jse_back, waist="Sailfi Belt +1", legs="Plun. Culottes +3", feet="Meg. Jam. +2"}
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {ammo="Seeth. Bomblet +1",
		head="Plun. Bonnet +3",  neck="Fotia Gorget",ear1="Sherida Earring",ear2="Moonshade Earring",
		body="Plunderer's Vest +3", hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Ilabrat Ring",
		back=gear.wsd_jse_back, waist="Sailfi Belt +1", legs="Plun. Culottes +3", feet="Plun. Poulaines +3"})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Yetshila",
		...
		--,hands="Adhemar Wrist. +1",rring="Begrudging Ring",
		body="Plunderer's Vest +3", hands="Meg. Gloves +2", ring1="Regal Ring", rring="Ilabrat Ring",
    ...
    sets.precast.WS['Evisceration'].Acc = set_combine(sets.precast.WS.Acc, {--ammo="Yetshila",
		...
		back=gear.crit_jse_back, waist="Fotia Belt", legs="Pill. Culottes +2", feet="Mummu Gamash. +2"})
    ...
    sets.precast.WS['Evisceration'].SA = set_combine(sets.precast.WS['Evisceration'].Fodder, {--ammo="Yetshila",
		...
		head="Mummu Bonnet +2", neck="Fotia Gorget",ear1="Sherida Earring",ear2="Moonshade Earring",
		-- body="Plunderer's Vest +3",hands="Adhemar Wrist. +1",rring="Begrudging Ring",
		body="Pillager's Vest +3", hands="Meg. Gloves +2", ring1="Regal Ring", rring="Ilabrat Ring",
		--  legs="Pill. Culottes +3",feet="Plun. Poulaines +3"})
		back=gear.crit_jse_back, waist="Fotia Belt", legs="Pill. Culottes +2", feet="Mummu Gamash. +2"})
	...
	sets.precast.WS["Savage Blade"] = set_combine(sets.precast.WS, {ammo="Seeth. Bomblet +1",
        -- Lustr Cap +1 Path A
		head="Pill. Bonnet +3",neck="Anu Torque",ear1="Sherida Earring",ear2="Brutal Earring",
        body="Pillager's Vest +3",hands="Meg. Gloves +2", ring1="Regal Ring", ring2="Rufescent Ring",
        back=gear.wsd_jse_back,waist="Prosilio Belt",legs="Meg. Chausses +2",feet="Meg. Jam. +2"})
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Seeth. Bomblet +1",
		...
		head="Mummu Bonnet +2", neck="Sanctity Necklace", lear="Hecate's Earring", rear="Friomisi Earring",
		body="Samnuha Coat", hands="Meg. Gloves +2", lring="Dingir Ring", rring="Shiva Ring",
		--waist="Eschan Stone",
		back=gear.wsd_jse_back, waist="Sailfi Belt +1", legs="Mummu Kecks +2", feet="Mummu Gamash. +2"}
    ...
    sets.engaged = {
		...
		body="Pillager's Vest +3", hands="Mummu Wrists +2", lring="Regal Ring", rring="Epona's Ring",
