...
function user_job_setup()
	...
	sets.weapons.PetWeaponsII = {main="Ohtas",range="Animator P II +1"}
	sets.weapons.Godhands = {main="Karambit",range="Animator P +1"}
	sets.weapons.GodhandsII = {main="Karambit",range="Animator P II +1"}
	--sets.weapons.Neo = {main="Ohtas",range="Neo Animator"}
	sets.weapons.AeolianEdge = {main="Tauret", sub="Kaja Knife", range="Animator P II +1"}

	-- Capes
	-- 
	gear.TP_jse_back = {name="Visucius's Mantle", augments={'STR+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}}
	-- VIt Acc wsd
	gear.WS_jse_back = {name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Haste+10',}}
	-- dex acc crit
	gear.Crit_jse_back = {name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Haste+10',}}
	gear.Pet_TP_jse_back = {name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Haste+10',}}
	-- meva FC DT
	gear.FC_jse_back = {name="Visucius's Mantle", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Pet: Haste+10',}}
...
function init_gear_sets()
    ...
    sets.precast.FC = {
		...
		back=gear.FC_jse_back ,waist="Isa Belt",legs="Pitre Churidars +1",} -- feet="Regal Pumps +1"
    ...
    sets.precast.JA['Repair'] = {ammo="Automat. Oil +3",
		-- Nibiru Sainti
		-- gear.herculean_Repair_head lear="Pratik Earring", rear="Guignol Earring"
    ...
    sets.precast.JA.Maneuver = {main="Midnights", range="Animator P +1",
		neck="Bfn. Collar +1",
    ...
    sets.precast.WS = {
        ...
        body="Foire Tobe +3",hands="Pitre Dastanas +2",ring1="Niqmaddu Ring",ring2="Regal Ring",
   ...
   -- Midcast Sets
    ...
    sets.idle = {main="Ohtas", range="Animator P +1",
        head="Tali'ah Turban +2",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Merman's Earring",
        body="Hiza. Haramaki +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Vocane Ring",
        back="Solemnity Cape",waist="Fucho-no-Obi",legs="Tali'ah Sera. +2",feet="Tali'ah Crackows +2"}
    ...
    sets.idle.Pet = {
        head="Pitre Taj +2",neck="Loricate Torque +1",ear1="Enmerkar Earring",ear2="Handler's Earring +1",
        body="Hiza. Haramaki +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2="Vocane Ring",
		back="Solemnity Cape",waist="Isa Belt",legs="Tali'ah Sera. +2",feet="Tali'ah Crackows +2"}
    ...
    sets.defense.PDT = {
        ...
        -- Malignance Tights  
		back="Solemnity Cape",waist="Isa Belt",legs="Tali'ah Sera. +2",feet="Malignance Boots"}
    ...
    sets.defense.MEVA = { 
        head="Maintenance Chapeau",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Genmei Earring",
        -- Malignance Tabard Malignance Gloves 
		body="Tali'ah Manteel +2",hands="Tali'ah Gages +2",ring1="Defending Ring",ring2=gear.DarkRing,
        -- Malignance Tights  
		back="Solemnity Cape",waist="Isa Belt",legs="Tali'ah Sera. +2",feet="Malignance Boots"}
    ...
    sets.engaged = {
        ...
        head="Tali'ah Turban +2",neck="Shulmanu Collar",ear1="Mache Earring +1",ear2="Mache Earring +1",
		...
		back=gear.TP_jse_back,waist="Windbuffet Belt",legs="Tali'ah Sera. +2",feet="Tali'ah Crackows +2"}
    sets.engaged.Acc = {
      -- Ryuo Somen +1 Mache Earring +1 ear2="Telos Earring",
        head="Tali'ah Turban +2",neck="Shulmanu Collar",ear1="Mache Earring +1",ear2="Mache Earring +1",
		-- gear.herculean_ta_hands Gere Ring
