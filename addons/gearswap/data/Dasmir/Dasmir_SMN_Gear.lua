...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {main=gear.skill_staff, sub="Vox Grip", 
		...
		body=gear.telchine_body_Siphon, hands="Glyphic Bracers +3",ring1="Stikini Ring +1", ring2="Stikini Ring +1",
        --waist="Kobo Obi",
    ...
    sets.precast.BloodPactWard = {main=gear.skill_staff,sub="Vox Grip",ammo=gear.avatar_ammo,
        ...
        -- hands="Baayami Cuffs",
		body="Con. Doublet +3", hands="Convo. Bracers +3", ring1="Evoker's Ring", ring2="Stikini Ring +1",
        -- back="Conveyance Cape", waist="Kobo Obi",  feet="Baayami Sabots"
		back="Astute Cape", waist="Cimmerian Sash", legs="Baayami Slops", feet="Convo. Pigaches +3"}
    ...
    sets.precast.FC = {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1",
		--  ammo="Impatiens", 
		head="Amalric Coif +1",neck="Voltsurge Torque", ear1="Malignance Earring", ear2="Enchntr. Earring +1",
    ...
    sets.precast.WS = {
        head="Convoker's Horn +3", neck="Shulmanu Collar", ear1="Digni. Earring", ear2="Ishvara Earring",
	...
	sets.precast.WS['Garland of Bliss'] = {ammo=gear.avatar_ammo, 
		...
		body="Witching Robe",hands="Amalric Gages +1", ring1="Shiva Ring", ring2="Rufescent Ring",
		back="Conveyance Cape", waist="Fotia Belt", legs="Tali'ah Sera. +2", feet="Amalric Nails +1"}
	--	73~85% INT
	sets.precast.WS['Shattersoul'] = {ammo=gear.avatar_ammo, 
		head="Welkin Crown",neck="Sanctity Necklace",ear1="Friomisi Earring",ear2="Novio Earring",
		body="Witching Robe",hands="Amalric Gages +1", ring1="Shiva Ring", ring2="Shiva Ring",
		back="Conveyance Cape", waist="Fotia Belt", legs="Tali'ah Sera. +2", feet="Amalric Nails +1"}
    ...
    sets.precast.WS['Myrkr'] = {ammo=gear.avatar_ammo, 
		...
		body="Con. Doublet +3",hands="Convo. Bracers +3", ring1="Mephitas's Ring +1", ring2="Mephitas's Ring",
	...
	sets.midcast['Elemental Magic'] = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		...
		head="Amalric Coif +1", neck="Sanctity Necklace", lear="Friomisi Earring", rear="Novia Earring",
		-- Fenrir Ring +1 Fenrir Ring +1 
		body="Inyanga Jubbah +2", hands="Amalric Gages +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.FC_jse_back, waist="Luminary Sash", legs="Inyanga Shalwar +2", feet="Amalric Nails +1"}
    ...
    sets.midcast.Stun = {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ammo="Pemphredo Tathlum",
		-- rear="Crematio Earring",
		head="Inyanga Tiara +2", neck="Sanctity Necklace", ear1="Malignance Earring", ear2="Enchntr. Earring +1",
		-- Fenrir Ring +1 Fenrir Ring +1 
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.FC_jse_back, waist="Luminary Sash", legs="Inyanga Shalwar +2", feet="Inyanga Crackows +2"}
		
    sets.midcast.Stun.Resistant = {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ammo="Pemphredo Tathlum",
		-- rear="Crematio Earring",
		head="Inyanga Tiara +2", neck="Erra Pendant", lear="Malignance Earring", ear2="Enchntr. Earring +1",
		-- Fenrir Ring +1 Fenrir Ring +1 
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.FC_jse_back, waist="Luminary Sash", legs="Inyanga Shalwar +2", feet="Inyanga Crackows +2"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- rear="Crematio Earring",
		head="Inyanga Tiara +2", neck="Sanctity Necklace", lear="Malignance Earring", ear2="Enchntr. Earring +1",
		-- Fenrir Ring +1 Fenrir Ring +1 
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.FC_jse_back, waist="Luminary Sash", legs="Inyanga Shalwar +2", feet="Inyanga Crackows +2"}
    ...
    sets.midcast.Pet.BloodPactWard = {main=gear.skill_staff, sub="Vox Grip", ammo=gear.avatar_ammo,
        ...
        -- hands="Baayami Cuffs",
		body="Beck. Doublet +1", hands="Glyphic Bracers +3", ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		--back="Conveyance Cape", waist="Kobo Obi",  
        waist="Cimmerian Sash", legs="Baayami Slops", feet="Baayami Sabots"}
    ...
    sets.midcast.Pet.DebuffBloodPactWard = {main=gear.macc_BP_Staff,sub="Vox Grip",ammo=gear.avatar_ammo,
		...
		-- ring1="Evoker's Ring",
        body="Con. Doublet +3", hands="Apogee Mitts +1",ring1="Stikini Ring +1", ring2="Stikini Ring +1",
    ...
    sets.midcast.Pet['Elemental Magic'].Resistant = set_combine(sets.midcast.Pet.MagicalBloodPactRage, {legs="Glyphic Spats +3"})
    ...
    sets.idle.PDT = {main="Earth Staff", sub="Khonsu", ammo=gear.avatar_ammo,
		...
		body="Udug Jacket", hands="Asteria Mitts +1", ring1="Gelatinous Ring +1", ring2="Defending Ring",
	...
	sets.idle.MDT = {main="Earth Staff", sub="Khonsu", ammo=gear.avatar_ammo,
        head="Inyanga Tiara +2",neck="Loricate Torque +1",ear1="Ethereal Earring",ear2="Etiolation Earring",
        body="Udug Jacket", hands="Inyan. Dastanas +2", ring1="Gelatinous Ring +1", ring2="Defending Ring",
		back=gear.FC_jse_back, waist="Regal Belt", legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2"}
    ...
    sets.idle.Avatar = {main="Nirvana", sub="Elan Strap +1", ammo=gear.avatar_ammo,
		-- Oneiros Grip 
        head="Convoker's Horn +3",neck="Caller's Pendant",ear1="Etiolation Earring",ear2="Evans Earring",
		-- ring1="Evoker's Ring",
        body="Apo. Dalmatica +1", hands=gear.merlinic_refresh_hands, ring1="Gelatinous Ring +1", ring2="Defending Ring",
