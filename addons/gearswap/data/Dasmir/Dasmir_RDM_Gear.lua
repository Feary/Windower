...
function init_gear_sets()
	...
	-- RDM gets 30 FC from traits and up to 8 more f/rom JP gifts. 80-38=42 
	sets.precast.FC = {main="Mafic Cudgel", sub="Genmei Shield", ammo="Hasty Pinion +1",
		-- sub="Sacro Bulwark", ammo="Staunch Tathlum +1" 
		head="Atrophy Chapeau +3", neck="Loricate Torque +1", ear1="Etiolation Earring", rear="Malignance Earring",
		--   Malignance Gloves
		body="Viti. Tabard +3", hands="Aya. Manopolas +2", lring="Gelatinous Ring +1", rring="Defending Ring",
		back=gear.FC_jse_back, waist="Witful Belt", legs="Malignance Tights", feet="Malignance Boots"}
	...
	sets.precast.WS['Savage Blade'] = {ammo="Ginsen",
		--  Duelist's Torque +2 
		head="Viti. Chapeau +3", neck="Sanctity Necklace", lear="Regal Earring", rear="Moonshade Earring",
		body="Viti. Tabard +3", hands="Atrophy Gloves +3", lring="Epaminondas's Ring", rring="Ilabrat Ring",
		back=gear.ws_jse_back, waist="Sailfi Belt +1", legs="Jhakri Slops +2", feet="Carmine Greaves +1"}
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",
		...
		body="Shamash Robe", hands="Jhakri Cuffs +2", lring="Epaminondas's Ring",  rring="Freke Ring",
	...
	sets.precast.WS['Aeolian Edge'] = {ammo="Pemphredo Tathlum",
		...
		-- body="Amalric Doublet +1", 
		body="Shamash Robe", hands="Jhakri Cuffs +2", lring="Epaminondas's Ring", rring="Freke Ring",
		back=gear.ws_jse_back, waist="Fotia Belt", legs="Jhakri Slops +2", feet="Amalric Nails +1"}
    ...
    sets.MagicBurst = {main="Daybreak", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		--head="Ea Hat +1", 	
		head="Atrophy Chapeau +3", neck="Mizu. Kubikazari", lear="Regal Earring", rear="Friomisi Earring",
		-- body="Ea Houppelande +1",
		body="Shamash Robe", hands="Amalric Gages +1", ring1="Mujin Band", ring2="Freke Ring",
		--waist="Refoccilation Stone", legs="Ea Slops +1", feet="Ea Pigaches +1"
		back=gear.nuke_jse_back, waist="Acuity Belt +1", legs="Jhakri Slops +2", feet="Amalric Nails +1"}
	sets.RecoverBurst = {main="Daybreak", sub="Ammurapi Shield",
		-- head="Ea Hat +1", 
		head="Atrophy Chapeau +3", neck="Mizu. Kubikazari", lear="Regal Earring", rear="Friomisi Earring",
	...
	sets.midcast.FastRecast = set_combine(sets.precast.FC, {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ammo="Hasty Pinion +1",
		head="Atrophy Chapeau +3", beck="Voltsurge Torque", lear="Loquac. Earring", rear="Enchntr. Earring +1",
		body="Viti. Tabard +3", hands="Leyline Gloves", lring="Prolix Ring", rring="Kishar Ring", 
    ...
    sets.midcast.Cure = {main="Daybreak", sub="Ammurapi Shield", ammo="Regal Gem",
		...
		head="Kaykaus Mitra +1", neck="Colossus's Torque", lear="Meili Earring", rear="Beatific Earring",
    ...
    sets.midcast.LightDayCure = {main="Chatoyant Staff", sub="Clerisy Strap +1", ammo="Regal Gem",
		-- neck="Incanter's Torque", 
		head="Kaykaus Mitra +1", neck="Colossus's Torque", lear="Meili Earring", rear="Beatific Earring",
		body="Kaykaus Bliaut +1", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Sirona's Ring",
		back=gear.Cure_jse_back, waist="Shinjutsu-no-Obi +1", legs="Kaykaus Tights +1", feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cursna =  set_combine(sets.midcast.Cure, {
		...
		--hands="Hieros Mittens",  ring1="Ephera Ring",
		body="Viti. Tabard +3", ring2="Menelaus's Ring", 
		-- path b  feet="Vanya Clogs"
		waist="Bishop's Sash",legs="Vanya Slops",})
	...
	sets.Self_Healing = {
		neck="Phalaina Locket", ring2="Kunaji Ring",
		waist="Gishdubar Sash"
		}
	sets.Cure_Received = {
		neck="Phalaina Locket", ring2="Kunaji Ring", waist="Gishdubar Sash"
		}
	sets.Self_Refresh = {back="Grapevine Cape", waist="Gishdubar Sash", feet="Inspirited Boots"}
	
	-- Duration
	sets.midcast['Enhancing Magic'] = {main="Pukulatmuj", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		-- Duelist's Torque +2  
	...
	sets.buff.ComposureOther = {main="Pukulatmuj", sub="Ammurapi Shield", ammo="Hasty Pinion +1",	
	...
	sets.midcast.Phalanx = {main="Naegling", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		...
		body="Viti. Tabard +3", hands=gear.taeon_hands_Phalanx, ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		back=gear.JSE_Cape, waist="Olympus Sash", legs=gear.taeon_legs_Phalanx, feet=gear.taeon_feet_Phalanx}
		
	-- Enhancing Magic Skill set
	sets.midcast['Temper'] = {main="Pukulatmuj", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
	...
	sets.midcast['Temper II'] = {main="Pukulatmuj",  sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		--main="Pukulatmuj +1",sub="Arendsi Fleuret",		
		-- Duelist's Torque +2 
	...
	sets.midcast.Refresh = {head="Amalric Coif +1",body="Atrophy Tabard +3", hands="Atrophy Gloves +3",  legs="Leth. Fuseau +1"} --  back="Grapevine Cape",waist="Gishdubar Sash",
	sets.midcast.Aquaveil = {main="Vadose Rod", sub="Genmei Shield", head="Amalric Coif +1",hands="Regal Cuffs",} --  waist="Emphatikos Rope", legs="Shedir Seraweels"
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak", sub="Ammurapi Shield", ammo="Regal Gem",
			...
			body="Atrophy Tabard +3", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
			back="Aurist's Cape +1", waist="Acuity Belt +1", legs=gear.chironic_macc_legs, feet="Vitiation Boots +3"}
	
	-- Path A - Pure Macc No Potency
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak", sub="Ammurapi Shield", ammo="Ullr",
			--  Dls. Torque +2
			head="Atrophy Chapeau +3", neck="Dls. Torque +1", lear="Regal Earring", rear="Malignance Earring",
			body="Atrophy Tabard +3", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
			back="Aurist's Cape +1", waist="Acuity Belt +1", legs=gear.chironic_macc_legs, feet="Vitiation Boots +3"}
	...
	sets.midcast['Blind'] = set_combine(sets.midcast['Enfeebling Magic'], {head="Viti. Chapeau +3", legs="Viti. Tights +3"})
	sets.midcast['Blind II'] = set_combine(sets.midcast['Enfeebling Magic'], {head="Viti. Chapeau +3", legs="Viti. Tights +3"})
	
	-- Path B MND + Potency Gear
	sets.midcast.MndEnfeebles = set_combine(sets.midcast['Enfeebling Magic'], {body="Atrophy Tabard +3"})
	sets.midcast.MndEnfeebles.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant, {body="Atrophy Tabard +3"})
	...
	sets.midcast['Slow II'].Resistant = set_combine(sets.midcast.MndEnfeebles, {head="Viti. Chapeau +3"})
	...
	sets.midcast['Dia III'] = set_combine(sets.midcast['Enfeebling Magic'], sets.TreasureHunter, {head="Viti. Chapeau +3"})
	
	sets.midcast.Bio = set_combine(sets.midcast['Enfeebling Magic'], sets.TreasureHunter)
	sets.midcast['Bio II'] = set_combine(sets.midcast['Enfeebling Magic'], sets.TreasureHunter)
	sets.midcast['Bio III'] = set_combine(sets.midcast['Enfeebling Magic'], sets.TreasureHunter, {head="Viti. Chapeau +3"})
	...
	sets.midcast['Elemental Magic'] = {main="Daybreak", sub="Ammurapi Shield", ammo="Pemphredo Tathlum", 
		...
		-- Amalric Doublet +1  
		body="Shamash Robe", hands="Amalric Gages +1", lring="Freke Ring", rring="Metamor. Ring +1",
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity", sub="Ammurapi Shield", ranged="Ullr", ammo=empty,
		...
		back="Aurist's Cape +1",waist="Acuity Belt +1", legs=gear.chironic_macc_legs, feet=gear.merlinic_aspir_feet}

    sets.midcast.Drain = {main="Rubicundity", sub="Ammurapi Shield", ranged="Ullr", ammo=empty,
		head="Pixie Hairpin +1", neck="Erra Pendant", ear1="Regal Earring", ear2="Malignance Earring",
        -- Shango Robe 
		body="Atrophy Tabard +3", hands="Aya. Manopolas +2", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		back="Aurist's Cape +1", waist="Fucho-no-obi", legs=gear.chironic_macc_legs, feet=gear.merlinic_aspir_feet}

	sets.midcast.Aspir = sets.midcast.Drain
		
	sets.midcast.Stun = {gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ammo="Hasty Pinion +1",
		head="Viti. Chapeau +3",neck="Voltsurge Torque", ear1="Regal Earring", ear2="Malignance Earring",
		body="Zendik Robe", hands="Leyline Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Aurist's Cape +1", waist="Witful Belt",legs=gear.chironic_macc_legs, feet=gear.merlinic_aspir_feet}
		
	sets.midcast.Stun.Resistant = {gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ranged="Ullr", ammo=empty,
		head="Atrophy Chapeau +3", neck="Voltsurge Torque", ear1="Regal Earring", ear2="Malignance Earring",
		body="Zendik Robe", hands="Leyline Gloves", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
		back="Aurist's Cape +1", waist="Acuity Belt +1", legs=gear.chironic_macc_legs, feet=gear.merlinic_aspir_feet}
	...
	sets.resting = {main="Daybreak",sub="Genmei Shield", -- ammo="Homiliary",
		...
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet=gear.merlinic_refresh_feet}
	
	-- Idle sets
	sets.idle = {main="Daybreak",sub="Genmei Shield", -- ammo="Homiliary",
		head="Viti. Chapeau +3",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		-- Lethargy Sayon +3 Volte Gloves
	...
	sets.idle.PDT = {main="Daybreak",sub="Genmei Shield", -- ammo="Staunch Tathlum",
		...
		body="Shamash Robe",hands="Aya. Manopolas +2",ring1="Gelatinous Ring +1",ring2="Defending Ring",
	...
	sets.idle.Weak = {main="Daybreak",sub="Genmei Shield", -- ammo="Staunch Tathlum",
		head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Malignance Tabard",hands="Aya. Manopolas +2",ring1="Gelatinous Ring +1",ring2="Defending Ring",
		-- Plat. Mog Belt
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
	
	sets.idle.DTHippo = set_combine(sets.idle.PDT, {feet="Hippomenes Socks"})
	...
	sets.defense.MDT = {main="Daybreak",sub="Genmei Shield", -- ammo="Staunch Tathlum",
		...
		body="Malignance Tabard",hands="Aya. Manopolas +2",ring1="Shadow Ring",ring2="Defending Ring",
		back=gear.FC_jse_back,waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	-- Weapons sets
	sets.weapons.Dagger = {main="Tauret", sub="Genmei Shield",range="Ullr"} -- ammo="Beetle Arrow"
	sets.weapons.Sword = {main="Crocea Mors", sub="Genmei Shield",range="Ullr"} --ammo="Beetle Arrow"
	sets.weapons.DualWeapons = {main="Naegling", sub="Kaja Sword"}-- Thibron
	sets.weapons.DualWeaponsAcc = {main="Naegling",sub="Kaja Sword"}
	sets.weapons.DualDagger = {main="Tauret", sub="Naegling"}
	sets.weapons.DualEvisceration = {main="Tauret",sub="Ae"}
	sets.weapons.DualAeolian = {main="Tauret",sub="Kaja Rod"} --Thibron
	sets.weapons.DualProcDaggers = {main="Blurred Knife +1",sub="Atoyac"}
	sets.weapons.EnspellOnly = {main="Aern Dagger",sub="Aern Dagger II",range="Ullr"}--ammo="Beetle Arrow"
	...
	sets.engaged.DT = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		...
		--  Malignance Gloves
		body="Malignance Tabard",hands="Aya. Manopolas +2",ring1="Defending Ring",ring2="Gelatinous Ring +1",
		back="Moonbeam Cape",waist="Windbuffet Belt",legs="Malignance Tights",feet="Malignance Boots"}
	...
	sets.engaged.EnspellOnly = {
		...
		head="Umuthi Hat",neck="Dls. Torque +1",ear1="Suppanomimi",ear2="Sherida Earring",
		body="Malignance Tabard",hands="Aya. Manopolas +2",ring1="Freke Ring", ring2="Chirich Ring +1",
	...
	sets.engaged.DW = {ammo="Ginsen", -- ammo="Aurgelmir Orb +1",
		...
		body="Malignance Tabard", hands="Aya. Manopolas +2", ring1="Chirich Ring +1",ring2="Chirich Ring +1",
		back=gear.stp_jse_back,waist="Windbuffet Belt",legs="Malignance Tights",feet="Malignance Boots"}
