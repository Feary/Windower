...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Paeapua",
		head="Halitus Helm", neck="Unmoving Collar +1", ear1="Friomisi Earring", ear2="Cryptic Earring",
    ...
    sets.precast.FC = {ammo="Impatiens",
		head="Herculean Helm",neck="Orunmila's Torque",ear1="Enchntr. Earring +1",ear2="Loquac. Earring",
    ...
    sets.precast.WS = {ammo="Yamarang",
        ...
        back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Samnuha Tights",feet="Lustra. Leggings +1"}
	...
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {ammo="Yamarang",
        ...
        body="Meg. Cuirie +2",hands="Maxixi Bangles +3",ring1="Ilabrat Ring",ring2="Regal Ring",
        back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Meg. Chausses +2",feet="Lustra. Leggings +1"})
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {ammo="Charis Feather",
		...
		body="Meg. Cuirie +2",hands="Maxixi Bangles +3",ring1="Ilabrat Ring",ring2="Regal Ring",
        back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Horos Tights +3",feet="Lustra. Leggings +1"})
    ...
    sets.precast.WS["Shark Bite"] = set_combine(sets.precast.WS, {ammo="Charis Feather", -- Coiste Bodhar 
        -- Maculele Tiara +2 Etoile Gorget +2
		...
		back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Horos Tights +3",feet="Lustra. Leggings +1"})
    sets.precast.WS["Shark Bite"].SomeAcc = set_combine(sets.precast.WS["Shark Bite"], {}) -- Crepsucular Pebble
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Ghastly Tathlum +1",
		-- Nyame Helm Sybil Scarf Moon
		head=empty, neck="Sanctity Necklace", lear="Moonshade Earring", rear="Friomisi Earring",
		-- Nyame Mail Nyame Gauntlets 
		body=empty, hands="Maxixi Bangles +3", lring="Epaminondas Ring", rring="Shiva Ring +1",
		-- Nyame Flanchard Nyame Sollerets
		back=gear.wsd_jse_back, waist="Orpheus Sash", legs="Horos Tights +3", feet=empty}
    ...
    sets.defense.MDT = {ammo="Staunch Tathlum +1",
        head="Malignance Chapeau",neck="Loricate Torque +1", ear1="Odnowa Earring +1",ear2="Odnowa Earring",
		-- Turms Harness +1
		body="Malignance Tabard",hands="Turms Mittens +1",ring1="Defending Ring",ring2="Purity Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Malignance Tights",feet="Malignance Boots"}
