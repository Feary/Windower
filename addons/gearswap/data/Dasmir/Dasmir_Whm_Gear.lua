...
function init_gear_sets()
	...
	sets.precast.FC.Cure.DT = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1", ammo="Incantor Stone",
		head="Piety Cap +3", neck="Loricate Torque +1", lear="Malignance Earring", rear="Nourish. Earring +1",
	...
	sets.precast.WS['Hexa Strike'] = {ammo=empty, -- Floestone
		-- Telos Earring
		head="Piety Cap +3", neck="Fotia Gorget", lear="Brutal Earring", rear="Moonshade Earring",
		-- rring="Begrudging Ring"
		body="Piety Bliaut +3", hands="Piety Mitts +3", lring="Ilabrat Ring", rring="Rufescent Ring",
	...
	sets.Self_Healing = {neck="Phalaina Locket",waist="Gishdubar Sash"}-- ring1="Kunaji Ring",ring2="Asklepian Ring"
	sets.Cure_Received = {neck="Phalaina Locket",waist="Gishdubar Sash"}-- ring1="Kunaji Ring",ring2="Asklepian Ring"
	sets.Self_Refresh = {feet="Inspirited Boots",waist="Gishdubar Sash"}-- back="Grapevine Cape",
	...
	sets.ConserveMP = {
        ...
        back="Aurist's Cape +1", waist="Shinjutsu-no-Obi +1", legs="Vanya Slops", feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cure = {main=gear.gada_healing_club, sub="Sors Shield", ammo="Pemphredo Tathlum", 
		...
		head="Kaykaus Mitra +1", neck="Clr. Torque +1", lear="Nourish. Earring +1", rear="Novia Earring",
		body="Kaykaus Blauit +1", hands="Theophany Mitts +3", lring="Menelaus's Ring", rring="Mephitas's Ring +1", 
	...
	sets.midcast.Cure.DT = {main="Mafic Cudgel", sub="Clerisy Strap +1", ammo="Pemphredo Tathlum", 
		head="Kaykaus Mitra +1", neck="Colossus's Torque", lear="Nourish. Earring +1", rear="Novia Earring",
		body="Kaykaus Blauit +1", hands="Theophany Mitts +3", lring="Defending Ring", rring="Mephitas's Ring +1",
		back=gear.Cure_jse_back, waist="Shinjutsu-no-Obi +1", legs="Ebers Pant. +1", feet="Kaykaus Boots +1"}
	...
	sets.midcast.Cursna = {
		...
		-- 
		back=gear.fastcast_jse_back, legs="Th. Pant. +3", feet="Gende. Galosh. +1"}
	
	-- -Na
	sets.midcast.StatusRemoval = set_combine(sets.midcast.FastRecast,{main=gear.grioavolr_fc_staff, sub="Clemency Grip", ammo="Hasty Pinion +1",
		-- Clr. Torque +2
		head="Ebers Cap +1", neck="Clr. Torque +1",
	...
	sets.midcast['Enhancing Magic'] = {main=gear.gada_enhancing_club, sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		...
		back="Mending Cape", waist="Olympus Sash", legs=gear.telchine_legs_Duration, feet="Theo. Duckbills +3"}

	-- Set bonus
	-- 500 Skill	
	sets.midcast.BarElement = {main="Beneficus", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- neck="Incantor's Torque", 
		head="Ebers Cap +1", neck="Colossus's Torque", lear="Andoaa Earring", rear="Mimir Earring",
		body="Ebers Bliaut +1", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back="Mending Cape", waist="Embla Sash", legs="Piety Pantaln. +3", feet="Ebers Duckbills +1"}
	sets.midcast.BarElement['Light Arts'] = {main="Beneficus", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- neck="Incantor's Torque",  
		head="Ebers Cap +1", neck="Colossus's Torque", lear="Andoaa Earring", rear="Mimir Earring",
	...
	sets.midcast.BarStatus = {main=gear.gada_enhancing_club, sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- neck="Incantor's Torque", 
		head=gear.telchine_head_Duration, neck="Colossus's Torque", lear="Andoaa Earring", rear="Mimir Earring",
		body=gear.telchine_body_Duration, hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back="Mending Cape", waist="Embla Sash", legs="Piety Pantaln. +3", feet="Theo. Duckbills +3"}
	...
	sets.midcast.BoostStat = {main=gear.gada_enhancing_club, sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- neck="Incantor's Torque" 
		head="Befouled Crown", neck="Colossus's Torque", lear="Andoaa Earring", rear="Mimir Earring",
		body=gear.telchine_body_Duration, hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back="Mending Cape", waist="Olympus Sash", legs="Piety Pantaln. +3", feet="Theo. Duckbills +3"}

	sets.midcast.BoostStat['Light Arts'] = {main=gear.gada_enhancing_club, sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		-- neck="Incantor's Torque",   
		head="Befouled Crown", neck="Colossus's Torque", lear="Andoaa Earring", rear="Mimir Earring",
		body=gear.telchine_body_Duration, hands=gear.telchine_hands_Duration, lring="Stikini Ring +1", rring="Stikini Ring +1",
		back="Mending Cape", waist="Olympus Sash", legs="Piety Pantaln. +3", feet="Theo. Duckbills +3"}
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {main="Bolelabunga", sub="Ammurapi Shield",
		...
		waist="Embla Sash", legs="Th. Pant. +3", feet=gear.telchine_feet_Regen})
	...
	sets.midcast.Impact = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		...
		back="Aurist's Cape +1", waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Theo. Duckbills +3"}
	...
	sets.midcast['Elemental Magic'] = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		...
		body="Inyanga Jubbah +2", hands="Inyan. Dastanas +2", lring="Shiva Ring +1", rring="Freke Ring",
		-- Chironic Hose Chironic Slippers 
		back="Aurist's Cape +1", waist="Luminary Sash", legs="Inyanga Shalwar +2", feet="Inyan. Crackows +2"}
    ...
    sets.midcast.Drain = {main="Rubicundity", sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
		...
		body="Theo. Bliaut +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		-- Chironic Hose Theo. Duckbills +3
		back="Aurist's Cape +1", waist="Luminary Sash", legs="Aya. Cosciales +2", feet="Theo. Duckbills +3"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		head="Theo. Cap +3", neck="Erra Pendant", lear="Malignance Earring", rear="Regal Earring",
		body="Theo. Bliaut +3", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Kishar Ring",
		-- Obstin. Sash
		back="Aurist's Cape +1", waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Theo. Duckbills +2"}

	sets.midcast['Enfeebling Magic'].Resistant = {main="Maxentius", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		head="Theo. Cap +3", neck="Erra Pendant", lear="Gwati Earring", rear="Regal Earring",
		body="Theo. Bliaut +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		--  Obstin. Sash
		back="Aurist's Cape +1", waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Theo. Duckbills +2"}
	...
	sets.midcast.MndEnfeebles.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant, {back="Aurist's Cape +1",ring1="Stikini Ring +1"})
	...
	sets.resting = {main=gear.grioavolr_refresh_staff, sub="Irenic Strap +1",
		...
		body="Theo. Bliaut +3", hands="Inyan. Dastanas +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.fastcast_jse_back, waist="Shinjutsu-no-Obi +1", legs="Assid. Pants +1", feet="Inyan. Crackows +2"}
	...
	sets.idle.MDT = {main=gear.grioavolr_refresh_staff, sub="Irenic Strap +1", ammo="Staunch Tahtlum +1",
		-- 
		head="Aya. Zucchetto +2", neck="Loricate Torque +1", lear="Ebani Earring", rear="Etiolation Earring",
		body="Ayanmo Corazza +2", hands="Aya. Manopolas +2", lring="Dark Ring", rring="Defending Ring",
		back=gear.fastcast_jse_back, waist="Fucho-no-Obi", legs="Aya. Cosciales +2", feet="Aya. Gambieras +2"}
	...
	sets.defense.MDT = {main=gear.grioavolr_refresh_staff, sub="Irenic Strap +1",
		...
		back=gear.fastcast_jse_back, waist="Shinjutsu-no-Obi +1", legs="Inyanga Shalwar +2", feet="Inyan. Crackows +2"}			
