...
function user_setup()
	...
	-- Snapshot
	gear.snapshot_jse_back = 	{name="Camulus's Mantle", ugments={'INT+20','Eva.+20 /Mag. Eva.+20','"Snapshot"+10',}}	
	-- Ranged TP
...
function init_gear_sets()
    ...
    sets.precast.CorsairRoll = {ammo="Compensator",
		-- neck="Regal Necklace", 
		head="Lanun Tricorne +1", lear="Etiolation Earring", rear="Odnowa Earring +1",
    ...
    sets.precast.CorsairShot = {ammo=gear.QDbullet,
		...
		head="Laksa. Tricorne", neck="Sanctity Necklace", lear="Friomisi Earring", rear="Novio Earring",
		-- Lanun Frac +3 Fenrir Ring +1
		body="Laksa. Frac", hands="Carmine Fin. Ga. +1", lring="Regal Ring", rring="Dingir Ring",
		-- Eschan Stone 
		back=gear.magic_QD_jse_back, waist="Yemaya Belt", legs="Mummu Kecks +1", feet="Laksa. Bottes"}
	
	-- STP 
    sets.precast.CorsairShot.STP = {ammo=gear.QDbullet,
		-- neck="Combatant's Torque", lear="Dedition Earring", rear="Telos Earring",
		head="Laksa. Tricorne", neck="Iskur Gorget", lear="Neritic Earring", rear="Enervating Earring",
		-- body="Oshosi Vest +1", lring="Chirich Ring +1", rring="Chirich Ring +1",
		body="Oshosi Vest", hands="Laksa. Gants", lring="Regal Ring", rring="Stikini Ring",
		-- waist="Kwahu Kachina Belt", feet="Lanun Boots +2"
		back=gear.magic_QD_jse_back, waist="Yemaya Belt", legs="Mummu Kecks +1", feet="Carmine Greaves +1"}
	
	-- Acc 
    sets.precast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
		-- neck="Combatant's Torque", lear="Diginitary Earring", 
		head="Laksa. Tricorne", neck="Voltsurge Torque", rear="Gwati Earring",
		body="Mummu Jacket", hands="Laksa. Gants", lring="Regal Ring", rring="Stikini Ring",
	...
	sets.precast.CorsairShot.Proc = {ammo=gear.RAbullet,
		...
		head="Laksa. Tricorne", neck="Sanctity Necklace", lear="Novio Earring", rear="Gwati Earring",
    ...
    sets.precast.WS = {
		...
		body="Laksa. Frac", hands="Meg. Gloves +2", lring="Regal Ring", rring="Epona's Ring",
		back=gear.magic_wsd_jse_back, waist="Wanion Belt", legs="Meg. Chausses +2", feet="Meg. Jam. +2"}
	
    sets.precast.WS.Acc = {
		head="Meghanada Visor +2", neck="Sanctity Necklace", lear="Bladeborn Earring", rear="Steelflash Earring",
		body="Laksa. Frac", hands="Meg. Gloves +2", lring="Rajas Ring", rring="Epona's Ring",
		back=gear.magic_wsd_jse_back, waist="Wanion Belt", legs="Meg. Chausses +2", feet="Meg. Jam. +2"}

    sets.precast.WS.Proc = {
		head="Meghanada Visor +2", neck="Loricate Torque +1", lear="Merman's Earring", rear="Merman's Earring",
		body="Laksa. Frac", hands="Meg. Gloves +2", lring="Gelatinous Ring +1", rring="Defending Ring",
		back=gear.magic_wsd_jse_back, waist="Wanion Belt", legs="Meg. Chausses +2", feet="Meg. Jam. +2"}
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {
		...
		body="Laksa. Frac", hands="Meg. Gloves +2", lring="Rufescent Ring", rring="Epona's Ring",
    ...
    sets.precast.WS['Last Stand'] = {ammo=gear.WSbullet,
		...
		body="Laksa. Frac", hands="Meg. Gloves +2", lring="Regal Ring", rring="Dingir Ring", 
		-- feet="Lanun Boots +3"
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
		...
		head="Mummu Bonnet", neck="Fotia Gorget", lear="Friomisi Earring",  rear="Moonshade Earring",
		-- Lanun Frac +3 
		body="Samnuha Coat", hands="Carmine Fin. Ga. +1", lring="Dingir Ring", rring="Regal Ring",
		-- Herc legs agi mdmg wsd
		back=gear.magic_wsd_jse_back, waist="Svelt. Gouriz +1", legs="Laksa. Trews +3", feet="Lanun Bottes +1"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        head="Meghanada Visor +2", neck="Loricate Torque +1", lear="Etiolation Earring", rear="Odnowa Earring +1",
		body="Meg. Cuirie +2", hands="Meg. Gloves +2", lring="Gelatinous Ring +1", rring="Defending Ring",
		-- back="Moonbeam Cape", Herc feet DT
		back=gear.snapshot_jse_back, waist="Flume Belt", legs="Mummu Kecks +1", feet="Meg. Jam. +2"}
    ...
    sets.defense.PDT = {ammo=gear.RAbullet,
		...
		back=gear.tp_ranger_jse_back, waist="Flume Belt", legs="Mummu Kecks +1", feet="Meg. Jam. +2"}
	...
	-- Fencer Savage 
	sets.weapons.SavageWeapons = {main="Naegling",sub="Nusku Shield", range="Anarchy"}--range="Ataktos"
	-- DW Savage
...
autows_list = {
		...
		['RollRangedWeapons']='Leaden Salute',
		['None']='Last Stand'}