...
function init_gear_sets()
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff, sub="Clerisy Strap +1", ammo="Hasty Pinion +1",
	...
	sets.precast.WS['Savage Blade'] = {--ammo="Ginsen",
		...
		back=gear.ws_jse_back, waist="Prosilio Belt", legs="Carmine Cuisses +1", feet="Carmine Greaves +1"}
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",
		...
		-- lring="Epaminodas's Ring", 
		body="Jhakri Robe +2", hands="Jhakri Cuffs +2", lring="Freke Ring", rring="Freke Ring",
    ...
    sets.MagicBurst = {main="Daybreak", sub="Ammurapi Shield", ammo="Pemphredo Tathlum",
		...
		body="Jhakri Robe +2", hands="Amalric Gages", ring1="Mujin Band", ring2="Freke Ring",
    ...
    sets.midcast.Cure = {main="Tamaxchi", sub="Thuellaic Ecu +1", ammo="Regal Gem",
		...
		body="Viti. Tabard +1", hands=gear.telchine_hands_Cure, lring="Stikini Ring +1", rring="Sirona's Ring",
		-- Atrophy Tights +3 Vanya Clogs
		back=gear.Cure_jse_back, waist="Bishop's Sash", legs="Atrophy Tights +1", feet="Carmine Greaves +1"}
    ...
    sets.midcast.LightDayCure = {main="Tamaxchi", sub="Thuellaic Ecu +1", ammo="Regal Gem",
		...
		body="Viti. Tabard +1", hands=gear.telchine_hands_Cure, lring="Stikini Ring +1", rring="Stikini Ring +1",
		-- Atrophy Tights +3 Vanya Clogs
		back=gear.Cure_jse_back, waist="Bishop's Sash", legs="Atrophy Tights +1", feet="Carmine Greaves +1"}
	...
	sets.midcast['Enhancing Magic'] = {main="Naegling", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		...
		-- Vitiation Tabard +3 Atrophy Gloves +3 
	...
	sets.midcast['Temper II'] = {main="Naegling",  sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		...
		-- Viti. Tabard +1 +3 Vitiation Gloves +3
		body="Viti. Tabard +1",hands="Viti. Gloves +1",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		-- Atrophy Tights +3 
		back=gear.JSE_Cape, waist="Olympus Sash",legs="Atrophy Tights +1",feet="Leth. Houseaux +1"}
	...
	sets.midcast.Refresh = {head="Amalric Coif +1",body="Atrophy Tabard +1", hands="Atrophy Gloves +1",  legs="Leth. Fuseau +1"} --  back="Grapevine Cape",waist="Gishdubar Sash",
	...
	sets.midcast['Enfeebling Magic'] = {main="Daybreak", sub="Ammurapi Shield", ammo="Regal Gem",
			--  Duelist's Torque +3 neck="Incanter's Torque", rear="Malignance Earring"
			head="Viti. Chapeau +1", neck="Erra Pendant", lear="Regal Earring", rear="Enchntr. Earring +1", 
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak", sub="Ammurapi Shield", ammo="Kaja Bow",
			--  Duelist's Torque +3 neck="Incanter's Torque",  rear="Malignance Earring"
			head="Atro. Chapeau +1", neck="Erra Pendant", lear="Regal Earring", rear="Enchntr. Earring +1", 
			body="Atrophy Tabard +1", hands="Kaykaus Cuffs +1", lring="Stikini Ring +1", rring="Stikini Ring +1",
			back=gear.Macc_jse_back, waist="Luminary Sash", legs=gear.chironic_macc_legs, feet="Vitiation Boots +1"}
	...
	sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Enfeebling Magic'], {head="Amalric Coif +1", waist="Acuity Belt"})
    sets.midcast.ElementalEnfeeble.Resistant = set_combine(sets.midcast['Enfeebling Magic'].Resistant, {head="Amalric Coif +1", waist="Acuity Belt"}) 
	...
	sets.midcast['Elemental Magic'] = {main="Daybreak", sub="Ammurapi Shield", ammo="Pemphredo Tathlum", 
		...
		-- Eschan Stone 
		back=gear.nuke_jse_back, waist="Acuity Belt +1", legs="Amalric Slops +1", feet="Amalric Nails"}
    ...
    sets.midcast['Elemental Magic'].Proc = {main=empty, sub=empty, ammo="Pemphredo Tathlum",
		...
		head="Atro. Chapeau +1", neck="Sanctity Necklace", lear="Regal Earring", rear="Friomisi Earring",
		body="Amalric Doublet +1", hands="Amalric Gages +1", lring="Freke Ring", rring="Shiva Ring",
		-- Eschan Stone 
		back=gear.nuke_jse_back, waist="Acuity Belt +1", legs="Amalric Slops +1", feet="Amalric Nails"}
	...
	sets.midcast.Impact = {main="Naegling", sub="Ammurapi Shield", ranged="Kaja Bow", ammo=empty,
		...
		-- Regal Cuffs
		body="Twilight Cloak", hands="Jhakri Cuffs +2", lring="Stikini Ring +1", rring="Stikini Ring +1",
		back=gear.Macc_jse_back, waist="Luminary Sash", legs="Ayanmo Cosciales +2", feet="Vitiation Boots +1"}
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity", sub="Ammurapi Shield", ranged="Kaja Bow", ammo=empty,
		...
		body="Atrophy Tabard +1", hands="Aya. Manopolas +2", ring1="Stikini Ring +1", ring2="Stikini Ring +1",
	...
	sets.midcast.Stun = {main="Daybreak", sub="Ammurapi Shield", ammo="Hasty Pinion +1",
		-- sub="Clerisy Strap +1", ear1="Regal Earring", ear2="Malignance Earring",
		head="Viti. Chapeau +1",neck="Voltsurge Torque", lear="Loquac. Earring", rear="Enchntr. Earring +1", 
