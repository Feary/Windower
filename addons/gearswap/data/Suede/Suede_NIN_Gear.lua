...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {ammo="Seeth. Bomblet +1",
		-- neck="Ninja Nodowa +2",
		head="Hachiya Hatsu. +2", neck="Caro Necklace", ear1="Moonshade Earring",ear2="Lugra Earring +1",
	...
	sets.precast.WS['Blade: Ku'] = {ammo="Seething Bomblet +1",
		...
		-- Agony Jerkin +1  Mochizuki Tekko +3 lring="Gere Ring",
	...
	sets.precast.WS['Blade: Kamu'] = {ammo="Seething Bomblet +1",
		...
		head="Hachiya Hatsu. +2", neck="Sanctity Necklace", lear="Lugra Earring", rear="Cessance Earring",
	...
	sets.precast.WS['Savage Blade'] = {ammo="Seething Bomblet +1",
		...
		head="Hachiya Hatsu. +2",neck="Caro Necklace",ear1="Lugra Earring",ear2="Moonshade Earring",
    ...
    sets.midcast.FastRecast = {}
	 ...
	 sets.midcast.NinjutsuDebuff = {ammo="Yamarang",
		-- lear="Hnoss Earring"
        head="Hachiya Hatsu. +2",neck="Sanctity Necklace",ear1="Enchntr. Earring +1",ear2="Digni. Earring",
		-- Malignance Tabard 
        body="Mummu Jacket +2",hands="Malignance Gloves",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
    ...
    sets.midcast.RA = {
		...
		-- Malignance Tabard 
        body="Ashera Harness", hands="Malignance Gloves", ring1="Ilabrat Ring", ring2="Regal Ring",
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
        ...
        body="Ashera Harness", hands="Malignance Gloves", ring1="Defending Ring", ring2="Vengeful Ring",
	...
	sets.DuskIdle = {feet="Hachiya Kyahan +2"}
	sets.DayIdle = {}
	sets.NightIdle = {}
    ...
    sets.engaged.DT = {ammo="Yamarang",
		...
		--  body="Malignance Tabard",
		body="Mummu Jacket +2",hands="Malignance Gloves", ring1="Defending Ring", ring2="Epona's Ring",
