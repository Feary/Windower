function user_setup()
	...
	gear.tp_jse_back = 		{name="Ogma's cape", augments={'STR+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}
	gear.da_jse_back = 		{name="Ogma's cape", augments={'STR+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}}
	gear.ws_jse_back = 		{name="Ogma's cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','Weapon skill damage +10%',}}
	gear.enmity_jse_back = 	{name="Ogma's cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','Parrying rate+5%',}}
	gear.hp_jse_back = 		{name="Ogma's cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','Phys. dmg. taken-10%',}}
	-- Hp fc meva
	...
	send_command('bind ^` gs c RuneElement')
	send_command('bind pause gs c cycle RuneElement')
	send_command('bind @pause gs c toggle AutoRuneMode')
	send_command('bind ^backspace input /ma "Phalanx" <me>')
	send_command('bind !backspace input /ma "Cure IV" <stal>')
	send_command('bind @backspace input /ma "Flash" <stnpc>')
	send_command('bind ^\\\\ input /ma "Protect IV" <t>')
	send_command('bind @\\\\ input /ma "Shell V" <t>')
	send_command('bind !\\\\ input /ma "Crusade" <me>')
	send_command('bind ^delete input /ja "Lunge" <t>')
	send_command('bind @delete input /ja "Gambit" <t>')
	send_command('bind !delete input /ja "Rayke" <t>')
...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Sapience Orb", -- 
		 -- Futhark Torque +2 Moonlight Necklace Trux Earring
	     head="Halitus Helm",neck="Moonlight Necklace",ear1="Genmei Earring",ear2="Cryptic Earring",
    ...
    sets.Enmity.SIRD = {ammo="Staunch Tathlum +1",
		-- Halaz Earring
	     head="Fu. Bandeau +3",neck="Moonlight Necklace",ear1="Genmei Earring",ear2="Cryptic Earring",
		 --  Rawhide Gloves
	     body="Futhark Coat +3",hands="Kurys Gloves",ring1="Defending Ring",ring2="Moonlight Ring",
		 -- Audumbla Sash
    ...
    sets.precast.Waltz = {ammo="Yamarang",
        head="Carmine Mask +1",neck="Moonlight Necklace",ear1="Enchntr. Earring +1",ear2="Handler's Earring +1",
        --ring2="Valseur's Ring",
		body="Futhark Coat +3",hands="Meg. Gloves +2",ring1="Defending Ring",
	...
	sets.precast.FC.DT = {ammo="Staunch Tathlum +1",
        ...
        body="Runeist's Coat +3",hands="Leyline Gloves",ring1="Defending Ring",ring2="Moonlight Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Eri. Leg Guards +1",feet="Erilaz Greaves +1"}
	
	sets.precast.FC.SIRD = {ammo="Staunch Tathlum +1",
        head="Rune. Bandeau +1",neck="Loricate Torque +1",ear1="Odnowa Earring +1",ear2="Odnowa Earring",
        body="Runeist's Coat +3",hands="Leyline Gloves",ring1="Defending Ring",ring2="Moonlight Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Eri. Leg Guards +1",feet="Erilaz Greaves +1"}
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.midcast.FastRecast,{
		...
		back=gear.FC_jse_back,waist="Olympus Sash",legs="Futhark Trousers +3"})
    ...
    sets.midcast.Cure = {ammo="Staunch Tathlum +1",
		...
		body="Erilaz Surcoat +1", hands="Kurys Gloves", ring1="Lebeche Ring", ring2="Moonlight Ring",
	...
	sets.idle.Tank = {ammo="Staunch Tathlum +1",
		...
		back=gear.hp_jse_back,waist="Flume Belt",legs="Eri. Leg Guards +1",feet="Turms Leggings +1"}
	...
	sets.defense.MEVA = {ammo="Staunch Tathlum +1",
		-- Futhark Torque
		head="Turms Cap +1",neck="Warder's Charm +1",ear1="Etiolation Earring",ear2="Hearty Earring",
	...
	sets.engaged.DTLite = {ammo="Staunch Tathlum +1",
            head="Fu. Bandeau +3",neck="Anu Torque",ear1="Telos Earring",ear2="Sherida Earring",
			body="Futhark Coat +3",hands="Turms Mittens +1",ring1="Defending Ring",ring2="Moonlight Ring",
            back=gear.tp_jse_back,waist="Kentarch Belt +1",legs="Meg. Chausses +2",feet="Turms Leggings +1"}
	...
	sets.buff.Battuta = {head="Fu. Bandeau +3"}
